...
export const es_ES: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.loadingTips.map': "Pulsa M para abrir el mapa del mundo y encontrar objetivos de misiones.",
  'hudChrome.loadingTips.quests': "Habla con los aldeanos marcados con ! para conseguir misiones.",
  'hudChrome.loadingTips.inspect': "Haz clic derecho en otro jugador para inspeccionar su equipo.",
  'hudChrome.loadingTips.camera': "Manten el boton derecho del raton para rotar la camara, y usa la rueda para acercar o alejar.",
  'hudChrome.loadingTips.chat': "Escribe /join world para chatear con todo el reino, o /join lfg para buscar grupo.",
  'hudChrome.loadingTips.rested': "Descansar en la ciudad acumula XP de descanso, asi subes de nivel mas rapido al volver.",
  'hudChrome.loadingTips.talents': "Gasta puntos de talento (N) al subir de nivel para definir tu build.",
