...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.ads.watchForRevive': '觀看一段短廣告即可在此復活',
  'hudChrome.ads.reviveReady': '在此復活！',
  'hudChrome.ads.watchForBoost': '觀看一段短廣告以獲得經驗加成',
  'hudChrome.ads.earnedRevive': '正在原地復活……',
  'hudChrome.ads.earnedBoost': '經驗加成已啟動！接下來 5 顆泡泡的擊殺經驗加倍。',
  'hudChrome.ads.adNotAvailable': '目前沒有可觀看的廣告。',
  'hudChrome.ads.boostOfferTitle': '你清空了副本！',
  'hudChrome.ads.skip': '不用了',
  'character.sortBy': '排序',
  ...
  'entities.zones.ashen_wastes.name': '灰燼荒原',
  'entities.zones.ashen_wastes.welcome': '灰燼荒原一望無際，灰暗而毫無生機。某個龐然之物低低地飄浮在死寂的大地之上。',
  'entities.zones.ashen_wastes.pois.0.label': '守墓哨',
  'entities.zones.ashen_wastes.pois.1.label': '灰燼隘口',
  'entities.zones.ashen_wastes.pois.2.label': '死寂之湖',
  'entities.zones.ashen_wastes.pois.3.label': '白骨之野',
  'entities.zones.ashen_wastes.pois.4.label': '空塚',
  'entities.zones.ashen_wastes.pois.5.label': '蒼白之境',
  ...
  'entities.quests.q_nythraxis_bound_guardian.text':
    '沃斯寫道，倖存者把國王印戒封在一名古老守衛身後，免得任何人因偶然或野心抵達尼思拉克西斯的陵墓。把墓穴鑰石帶到廢棄墓穴西北、大祭司馬爾里克之墓東北方平地上的儀式法陣。在那裡使用它，擊破守衛，並帶回印戒。',
  ...
  'hudChrome.character.tabsAria': '角色視窗標籤頁',
  'hudChrome.character.tabOverview': '角色',
  'hudChrome.character.tabReputation': '聲望',
  'hudChrome.reputation.empty': '你還沒有任何聲望。',
  'hudChrome.reputation.maxed': '已滿',
  'hudChrome.reputation.requires': "需要{faction}聲望達到{standing}",
  'hudChrome.reputation.lockedHint': "你需要更高的聲望才能購買此物品。",
  'hudChrome.reputation.standing.hated': '仇恨',
  'hudChrome.reputation.standing.hostile': '敵對',
  'hudChrome.reputation.standing.unfriendly': '不友好',
  'hudChrome.reputation.standing.neutral': '中立',
  'hudChrome.reputation.standing.friendly': '友好',
  'hudChrome.reputation.standing.honored': '尊敬',
  'hudChrome.reputation.standing.revered': '崇敬',
  'hudChrome.reputation.standing.exalted': '崇拜',
  'hudChrome.reputation.faction.dawnOfClaude': '克勞德黎明',
  ...
  'entities.items.blight_sample.name': "污染樣本",
  'entities.items.cult_orders.name': "腐化的命令書",
  'entities.items.desecrated_relic.name': "被褻瀆的聖物",
  'entities.items.ritual_focus.name': "儀式法器",
  'entities.items.ship_fragment.name': "船艦碎片",
  'entities.items.hollow_heart.name': "空洞之心",
  'entities.items.sigil_of_the_dawn.name': "黎明印記",
  'entities.items.ashen_warboots.name': "灰燼戰靴",
  'entities.items.ashen_slippers.name': "灰燼軟鞋",
  'entities.items.ashen_treads.name': "灰燼踏靴",
  'entities.items.dawnward_gauntlets.name': "守曦護手",
  'entities.items.dawnward_gloves.name': "守曦手套",
  'entities.items.dawnward_grips.name': "守曦緊握",
  'entities.items.behemoth_girdle.name': "巨獸腰甲",
  'entities.items.behemoth_sash.name': "巨獸腰帶",
  'entities.items.behemoth_belt.name': "巨獸束帶",
  'entities.items.deathward_helm.name': "禦死頭盔",
  'entities.items.deathward_hood.name': "禦死兜帽",
  'entities.items.deathward_cowl.name': "禦死頭巾",
  'entities.items.gravelord_pauldrons.name': "墓主肩甲",
  'entities.items.gravelord_amice.name': "墓主披肩",
  'entities.items.gravelord_spaulders.name': "墓主護肩",
  'entities.items.dawnguard_sabatons.name': "黎明衛戰靴",
  'entities.items.dawnguard_gauntlets.name': "黎明衛護手",
  'entities.items.dawnguard_girdle.name': "黎明衛腰甲",
  'entities.items.dawnguard_greathelm.name': "黎明衛巨盔",
  'entities.items.dawnguard_legplates.name': "黎明衛腿甲",
  'entities.items.dawnguard_pauldrons.name': "黎明衛肩甲",
  'entities.items.dawnguard_breastplate.name': "黎明衛胸甲",
  'entities.items.dawnguard_blade.name': "黎明衛之刃",
  'entities.items.dawn_slippers.name': "黎明軟鞋",
  'entities.items.dawn_handwraps.name': "黎明手綁帶",
  'entities.items.dawn_cord.name': "黎明束繩",
  'entities.items.dawn_cowl.name': "黎明頭巾",
  'entities.items.dawn_leggings.name': "黎明護腿",
  'entities.items.dawn_mantle.name': "黎明披風",
  'entities.items.dawn_robe.name': "黎明長袍",
  'entities.items.dawn_scepter.name': "黎明權杖",
  'entities.items.dawnstalker_treads.name': "曦行者踏靴",
  'entities.items.dawnstalker_grips.name': "曦行者緊握",
  'entities.items.dawnstalker_belt.name': "曦行者束帶",
  'entities.items.dawnstalker_mask.name': "曦行者面具",
  'entities.items.dawnstalker_legguards.name': "曦行者護腿",
  'entities.items.dawnstalker_spaulders.name': "曦行者護肩",
  'entities.items.dawnstalker_tunic.name': "曦行者外衣",
  'entities.items.dawnstalker_dagger.name': "曦行者匕首",
  'entities.mobs.blighted_husk.name': "枯萎軀殼",
  'entities.mobs.ashen_ghoul.name': "灰燼食屍鬼",
  'entities.mobs.plague_crawler.name': "瘟疫爬行者",
  'entities.mobs.corrupted_acolyte.name': "腐化侍僧",
  'entities.mobs.bone_reaver.name': "白骨掠奪者",
  'entities.mobs.wraithling.name': "塚地幽靈",
  'entities.mobs.rotting_behemoth.name': "腐爛巨獸",
  'entities.mobs.plaguebringer_zealot.name': "瘟疫狂信徒",
  'entities.mobs.naxx_deathguard.name': "納克薩瑪斯死亡守衛",
  'entities.mobs.morthax_the_hollow.name': "空洞者莫薩克斯",
  'entities.mobs.gravelord_oss.name': "墓主奧斯",
  'entities.npcs.dawn_commander_sera.name': "瑟拉指揮官",
  'entities.npcs.dawn_commander_sera.title': "克勞德黎明",
  'entities.npcs.dawn_commander_sera.greeting': "守住防線，{className}。那座漂浮的墳塚，克勞德薩瑪斯（Claudexxaramas），已將這整片土地染成灰白。克勞德黎明定要將它奪回，一個亡魂接著一個亡魂地奪回。",
  'entities.npcs.dawn_chaplain_orin.name': "歐林牧師",
  'entities.npcs.dawn_chaplain_orin.title': "克勞德黎明",
  'entities.npcs.dawn_chaplain_orin.greeting': "聖光依然能照及此地，{playerName}，儘管已然微弱。幫我照料瀕死之人，並打破那艘船傾瀉而下的瘟疫吧。",
  'entities.npcs.dawn_quartermaster_henning.name': "軍需官亨寧",
  'entities.npcs.dawn_quartermaster_henning.title': "克勞德黎明",
  'entities.npcs.dawn_quartermaster_henning.greeting': "鋼鐵與信念，{playerName}，這就是我所能給予的一切。贏得黎明的信任，軍需官的儲藏便會為你逐件開啟。",
  'entities.npcs.dawn_scout_irelle.name': "斥候艾蕊兒",
  'entities.npcs.dawn_scout_irelle.title': "克勞德黎明",
  'entities.npcs.dawn_scout_irelle.greeting': "我已將這些死亡之路繪製到我膽敢前往的最北處，{className}。越是接近蒼白邊境，那艘船的低語便越是響亮。小心你的腳步。",
  'entities.npcs.dawn_archivist_vael.name': "檔案官維爾",
  'entities.npcs.dawn_archivist_vael.title': "克勞德黎明",
  'entities.npcs.dawn_archivist_vael.greeting': "我能研究的每一片那座死靈城的碎片，都是我們或許有朝一日能撬開的裂縫，{playerName}。把死者身上攜帶之物帶來給我，我們便一同謀劃這場突破。",
  'entities.quests.q_aw_arrival.title': "灰燼與凶兆",
  'entities.quests.q_aw_arrival.text': "歡迎來到守墓堡，{playerName}，至少是枯萎瘟疫為我們留下的那一點殘餘。每晚都有倒下者的軀殼撕扯著我們的城牆。把其中八具放倒，好讓我的士兵能夠安睡，克勞德黎明便會把你視為一位日益深交的朋友。",
  'entities.quests.q_aw_arrival.completion': "城門前少了八個恐怖之物。你的手很穩，{playerName}。黎明銘記每一位與我們並肩之人。",
  'entities.quests.q_aw_arrival.objectives.0.label': "枯萎軀殼已殺",
  'entities.quests.q_aw_husks.title': "行走的枯萎瘟疫",
  'entities.quests.q_aw_husks.text': "這些軀殼並非毫無心智，{playerName}，牠們會聚集，會試探我們的防線。在牠們摸清我們最薄弱之處前，再剷除十二具。拿上這雙踏靴行走吧，這片荒野對靴子可不留情。",
  'entities.quests.q_aw_husks.completion': "很好。你焚毀的每一具軀殼，都是今夜無法再度爬起的一具。",
  'entities.quests.q_aw_husks.objectives.0.label': "枯萎軀殼已殺",
  'entities.quests.q_aw_ghouls.title': "野性的飢渴",
  'entities.quests.q_aw_ghouls.text': "灰燼食屍鬼成群獵食於白骨原野之上，迅捷而瘋狂。牠們已拖走了我兩名斥候。削減牠們，十隻應該足以打散這群東西，趁牠們還沒膽大到敢直衝城門。",
  'entities.quests.q_aw_ghouls.completion': "鬼群已被打散。多虧了你，我的斥候又能在白骨原野上巡遊了。",
  'entities.quests.q_aw_ghouls.objectives.0.label': "灰燼食屍鬼已殺",
  'entities.quests.q_aw_crawlers.title': "蔓延的病疫",
  'entities.quests.q_aw_crawlers.text': "瘟疫爬行者的撕咬中帶著枯萎瘟疫，{playerName}，牠們在靜湖的泥沼中繁殖。殺掉牠們十隻。牠們走過之處，病疫便隨之而來，而我這裡已有太多病床躺滿了人。",
  'entities.quests.q_aw_crawlers.completion': "病床上的護咒如今能再撐久一些了。聖光感謝你，即便我有時忘了道謝。",
  'entities.quests.q_aw_crawlers.objectives.0.label': "瘟疫爬行者已殺",
  'entities.quests.q_aw_samples.title': "污染的樣本",
  'entities.quests.q_aw_samples.text': "要治癒這枯萎瘟疫，我必須先理解它。那些軀殼與爬行者全身浸透了瘟疫，給我帶來六份牠們腐化血肉的污染樣本，並小心處理。那污染可不在乎它玷污的是誰的血。",
  'entities.quests.q_aw_samples.completion': "六份樣本，一份比一份更糟。這腐化是……有規律的，是刻意為之的。這絕非自然的瘟疫，{playerName}。",
  'entities.quests.q_aw_samples.objectives.0.label': "污染樣本",
  'entities.quests.q_aw_acolytes.title': "船艦之聲",
  'entities.quests.q_aw_acolytes.text': "如今活人也跪拜於克勞德薩瑪斯之前，{playerName}，那些腐化的侍僧在荒野上吟誦著它的意志。他們已不再是我們所能拯救之人。讓其中十人安靜下來。拿上這雙護手吧，在此事了結之前，你還會遭遇更糟的。",
  'entities.quests.q_aw_acolytes.completion': "吟誦聲動搖了。無論那艘船在建造什麼，你都讓它折損了十條甘願獻身的喉嚨。",
  'entities.quests.q_aw_acolytes.objectives.0.label': "腐化侍僧已殺",
  'entities.quests.q_aw_orders.title': "來自上方的命令",
  'entities.quests.q_aw_orders.text': "那些侍僧攜帶著書面命令，{playerName}，船開口言語，他們便謄錄下來。再砍倒八人，給我帶來四份那樣的命令書。我要在克勞德薩瑪斯所下達的命令臨到我們之前，先弄清它究竟下了什麼令。",
  'entities.quests.q_aw_orders.completion': "這文字在你注視時彷彿在爬動。但確實是命令，一點不假：聚集死者，備妥蒼白邊境。他們正在為某件事做準備。",
  'entities.quests.q_aw_orders.objectives.0.label': "腐化侍僧已殺",
  'entities.quests.q_aw_orders.objectives.1.label': "腐化的命令書",
  'entities.quests.q_aw_reavers.title': "白骨原野",
  'entities.quests.q_aw_reavers.text': "那些白骨掠奪者是行走的軍械庫，{playerName}，是被重鑄成船之利刃的舊日士兵。在白骨原野上擊碎牠們十二具。你打散的每一個掠奪者，都是再也不會揮向黎明的鋼鐵。",
  'entities.quests.q_aw_reavers.completion': "十二個掠奪者碎成了渣。那樣的殘料能讓我的鍛爐繼續燃燒。幹得好。",
  'entities.quests.q_aw_reavers.objectives.0.label': "白骨掠奪者已殺",
  'entities.quests.q_aw_wraiths.title': "空洞塚地",
  'entities.quests.q_aw_wraiths.text': "此地以北的古老塚地已然甦醒，{playerName}。塚地幽靈從墳墓中飄出，那是會吸盡生者體溫的冰冷之物。讓其中十個安息。這片荒野的死者，理應得到比侍奉那艘船更好的歸宿。",
  'entities.quests.q_aw_wraiths.completion': "十個亡魂得以重歸黑暗的安寧。我依你所述為每一個禱告。這是微小的慈悲，但它屬於我們。",
  'entities.quests.q_aw_wraiths.objectives.0.label': "塚地幽靈已殺",
  'entities.quests.q_aw_relics.title': "受祝聖的聖物",
  'entities.quests.q_aw_relics.text': "那些塚地藏有舊日信仰的聖物，曾受祝聖，如今卻被幽靈的觸碰所褻瀆。從墳墓中尋回五件，{playerName}。經過淨化與重新祝福，它們護衛病床的效力，將遠勝我那些日漸無力的禱告。",
  'entities.quests.q_aw_relics.completion': "五件聖物，當污染消退時，每一件都在我手中變得溫熱。聖光並未離棄此地。它只是需要有人將它帶回家。",
  'entities.quests.q_aw_relics.objectives.0.label': "被褻瀆的聖物",
  'entities.quests.q_aw_hold.title': "堅守守墓堡",
  'entities.quests.q_aw_hold.text': "說句實話，{playerName}：我們正在節節敗退。那些掠奪者每晚都更加猛烈地進逼白骨原野。我需要再擊碎其中十四個，好為守備隊換來一週的喘息。黎明能指望你嗎？",
  'entities.quests.q_aw_hold.completion': "一週。你為我們換來了一週。我不會白白浪費它，也絕不會忘記是誰換來了它。",
  'entities.quests.q_aw_hold.objectives.0.label': "白骨掠奪者已殺",
  'entities.quests.q_aw_behemoth.title': "腐爛巨獸",
  'entities.quests.q_aw_behemoth.text': "有個龐然大物在靜湖上移動，{playerName}，那是一頭由縫合腐爛的屍體拼湊而成的巨獸，大得足以像踏過籬笆般踏穿我們的城牆。帶上一兩名同伴，在它抵達守墓堡之前將它放倒。這條腰甲應能幫你承受牠的打擊。",
  'entities.quests.q_aw_behemoth.completion': "你放倒了那座血肉之山。我在這上頭都感到大地停止了震動。為了這一仗，黎明欠你一份人情。",
  'entities.quests.q_aw_behemoth.objectives.0.label': "腐爛巨獸已殺",
  'entities.quests.q_aw_zealots.title': "瘟疫散播者",
  'entities.quests.q_aw_zealots.text': "瘟疫狂信徒在通往蒼白邊境的路上播下一陣陣腐爛，{playerName}，而且他們互相治療的速度比一柄孤刃放倒他們的速度還快。殺掉八個。狠狠地打，齊心地打，別讓他們繞成圈互相療傷。",
  'entities.quests.q_aw_zealots.completion': "八個狂信徒，他們散播的腐爛也隨之而亡。那條路又能通行了，僅僅是勉強而已。",
  'entities.quests.q_aw_zealots.objectives.0.label': "瘟疫狂信徒已殺",
  'entities.quests.q_aw_deathguard.title': "船艦的守衛",
  'entities.quests.q_aw_deathguard.text': "那些納克薩瑪斯死亡守衛是船自己的看守者，{playerName}，是身著黑色重甲的精英死者，駐守在克勞德薩瑪斯懸得最低之處。擊碎其中十個。我需要知道黎明能否在這死靈城的陰影正下方作戰。這頂頭盔曾屬於一名死亡守衛；戴上它去對付他們吧。",
  'entities.quests.q_aw_deathguard.completion': "十名看守者倒下，就在船自己的陰影之中。那麼，這事便辦得到。那麼，總有一天，我們便能將這場戰鬥打上去。是你讓我看見了這一點，{playerName}。",
  'entities.quests.q_aw_deathguard.objectives.0.label': "納克薩瑪斯死亡守衛已殺",
  'entities.quests.q_aw_morthax.title': "空洞之主",
  'entities.quests.q_aw_morthax.text': "上個季節，我們的一員倒在了空洞塚地之中，那是一位名叫莫薩克斯的騎士。那艘船將他喚起，{playerName}，如今空洞者莫薩克斯獵殺著他曾經率領的人。找到他。終結他。把他的心臟帶回給我，好讓我確信那披著他面容的東西真的已經消失。",
  'entities.quests.q_aw_morthax.completion': "冰冷。這心臟冷如磐石，空洞得正如他們給他的那個名字。安息吧，莫薩克斯。你侍奉黎明直到最後一刻，甚至超越了那一刻。",
  'entities.quests.q_aw_morthax.objectives.0.label': "空洞之心",
  'entities.quests.q_aw_pale_reach.title': "深入蒼白邊境",
  'entities.quests.q_aw_pale_reach.text': "蒼白邊境是其中最糟的地方，{playerName}，那是直接位於那艘錨定之船下方的空曠之地，密布著死亡守衛。我無法獨自將它繪製出來。為我開出一條路：放倒八名納克薩瑪斯死亡守衛，讓我在你身後勾勒地形。",
  'entities.quests.q_aw_pale_reach.completion': "我拿到手了，整片邊境，終於繪製完成，每一支巡邏隊、每一座尖塔。檔案官維爾會想要這份的。指揮官也會，等到向那艘船進軍的那一天來臨之時。",
  'entities.quests.q_aw_pale_reach.objectives.0.label': "納克薩瑪斯死亡守衛已殺",
  'entities.quests.q_aw_ritual.title': "破除儀式",
  'entities.quests.q_aw_ritual.text': "那些狂信徒正在蒼白邊境上施行一場儀式，要將克勞德薩瑪斯再拉低一些，{playerName}。他們每人都攜帶一件用以錨定儀式的儀式法器。奪走其中四件，並在此過程中殺死六名狂信徒，斬斷那些錨點，儀式便會停滯。",
  'entities.quests.q_aw_ritual.completion': "那些法器一離開邊境便立刻黯滅。四個錨點已斷。那艘船今日不會再懸得更低，這便是一場勝利，無論它多麼渺小。",
  'entities.quests.q_aw_ritual.objectives.0.label': "儀式法器",
  'entities.quests.q_aw_ritual.objectives.1.label': "瘟疫狂信徒已殺",
  'entities.quests.q_aw_attune_1.title': "克勞德薩瑪斯的回響",
  'entities.quests.q_aw_attune_1.text': "要突破這座死靈城，我們必須先理解它，{playerName}。它的看守者攜帶著它船殼的碎片，那是仍與船同律共鳴的死亡金屬。從死亡守衛身上給我帶來三片船艦碎片，我便會開始學習納克薩瑪斯的歌謠。",
  'entities.quests.q_aw_attune_1.completion': "它們彼此共鳴，聽。同一首輓歌的三個音符。只要有足夠多這樣的碎片，檔案官，我便能繪製出通往內部的路徑。我們就是要這樣突破它。",
  'entities.quests.q_aw_attune_1.objectives.0.label': "船艦碎片",
  'entities.quests.q_aw_gravelord.title': "墓主奧斯",
  'entities.quests.q_aw_gravelord.text': "墓主奧斯是船在地面上的手，{playerName}，是將整片枯萎瘟疫錨定於蒼白邊境的副官。召集你最強的同伴；這絕非一人之戰，甚至三人也不足夠。砍倒這位墓主，這片荒野本身或許便會開始癒合。",
  'entities.quests.q_aw_gravelord.completion': "奧斯死了，看哪，邊境上的灰燼已開始褪向灰綠之色。你殺死的不只是一名副官，{playerName}。你向黎明證明了：克勞德薩瑪斯也會流血。",
  'entities.quests.q_aw_gravelord.objectives.0.label': "墓主奧斯已殺",
  'entities.quests.q_aw_attunement.title': "突破納克薩瑪斯",
  'entities.quests.q_aw_attunement.text': "奧斯既死，墓主的錨點已斷，那艘船如今懸於脆弱之境，{playerName}。就是此刻。再給我帶來五片船艦碎片，我便會將它們鍛造成一枚黎明印記，那是你對納克薩瑪斯本身的共鳴標記。當克勞德黎明終於攻入那座死靈城時，持有印記者將引領這場突破，而這場攻勢付出的鮮血與鋼鐵，將只需原本的一半。",
  'entities.quests.q_aw_attunement.completion': "成了。黎明印記歸你所有，{playerName}，這是向這支教團中每一個亡魂證明你已為這座死靈城做好準備的明證。當我們向克勞德薩瑪斯進軍時，你將走在最前。在我們之中受人崇敬，與這場突破共鳴相連。黎明再也尋不到比你更真誠的勇士了。",
  'entities.quests.q_aw_attunement.objectives.0.label': "船艦碎片",
  // Claudeholme dungeon + Breachkey chain
  'entities.dungeons.claudeholme.name': "克勞德霍姆",
  'entities.dungeons.claudeholme.enterText': "你穿過裂隙進入克勞德霍姆，死寂的城鎮開始騷動。",
  'entities.dungeons.claudeholme.leaveText': "你從克勞德霍姆爬回灰燼般的天光之下。",
  'entities.dungeons.claudexxaramas.name': "克勞德薩拉瑪斯",
  'entities.dungeons.claudexxaramas.enterText': "你突破了克勞德薩拉瑪斯的死域。亡者正等候著你。",
  'entities.dungeons.claudexxaramas.leaveText': "你撤離克勞德薩拉瑪斯，沒入灰燼之風中。",
  'entities.mobs.blighted_stag.name': "枯疫雄鹿",
  'entities.mobs.rotting_fox.name': "腐爛之狐",
  'entities.npcs.dawn_huntsman_varik.name': "獵人瓦里克",
  'entities.npcs.dawn_huntsman_varik.title': "克勞德黎明",
  'entities.npcs.dawn_huntsman_varik.greeting': "腐疫已經蔓延到野獸身上了，{playerName}。南方荒原的雄鹿眼中燃著綠色火焰甦醒過來，狐狸則啃食牠們留下的殘骸。我獵殺牠們，好讓腐化不再向外擴散。借我你的弓，或是你的刃。",
  'entities.quests.q_aw_rotting_herd.title': "腐爛的鹿群",
  'entities.quests.q_aw_rotting_herd.text': "南方荒原的雄鹿已經不再是雄鹿了，{playerName}。枯疫吞噬了整群鹿，如今牠們會衝撞任何還在呼吸的東西，鹿角上滴落著綠色的膿水。把牠們的數量減下去，殺掉八頭應該能瓦解鹿群，趁牠們還沒往北遊蕩到守墓哨之前。",
  'entities.quests.q_aw_rotting_herd.completion': "荒原上又少了八頭腐爛的野獸。今晚鹿群到不了營地了。你獵得很好，{playerName}。",
  'entities.quests.q_aw_rotting_herd.objectives.0.label': "已擊殺枯疫雄鹿",
  'entities.quests.q_aw_ash_scavengers.title': "灰燼中的食腐者",
  'entities.quests.q_aw_ash_scavengers.text': "雄鹿倒下之處，狐狸便會聚來，{playerName}。這些腐爛的小食腐獸每拖走一具屍骸，就把枯疫散播得更遠。宰掉牠們八隻，別讓腐化繼續爬蔓。",
  'entities.quests.q_aw_ash_scavengers.completion': "食腐者已被驅散。很好。你每殺一隻，就是讓一哩荒原多保持一陣子的潔淨。",
  'entities.quests.q_aw_ash_scavengers.objectives.0.label': "已擊殺腐爛之狐",
  'entities.quests.q_aw_corrupt_sample.title': "腐疫之種",
  'entities.quests.q_aw_corrupt_sample.text': "我想知道枯疫在這些野獸體內究竟有多深，{playerName}。從雄鹿身上帶六支染疫的鹿角給我，綠疫在骨頭裡潰爛得最厲害，我便能判讀它擴散的速度。倘若鹿群已經無可挽回，克勞德黎明必須知曉。",
  'entities.quests.q_aw_corrupt_sample.completion': "六支鹿角，每一支都已腐爛到了骨髓。枯疫如今深入牠們的骨髓了，{playerName}。鹿群再也無法挽救，只能了結牠們。但克勞德黎明已知曉自己面對的是什麼，這比一場乾淨俐落的獵殺更有價值。",
  'entities.quests.q_aw_corrupt_sample.objectives.0.label': "染疫鹿角",
  'entities.items.tainted_antler.name': "染疫鹿角",
  'entities.mobs.cx_husk.name': "死域空殼",
  'entities.mobs.cx_revenant.name': "死域亡魂",
  'entities.mobs.cx_flesh_thrall.name': "血肉奴僕",
  'entities.mobs.cx_plague_swarm.name': "瘟疫蟲群",
  'entities.mobs.cx_spiderling.name': "墓穴幼蛛",
  'entities.mobs.cx_gutpile.name': "腸堆",
  'entities.mobs.cx_fleshwright.name': "血肉匠師",
  'entities.mobs.cx_grosh.name': "未成者葛羅什",
  'entities.mobs.cx_vexil.name': "腐潰者維克希爾",
  'entities.mobs.cx_apothecary.name': "藥劑三人組",
  'entities.mobs.cx_maggath.name': "瘟疫領主瑪嘉斯",
  'entities.mobs.cx_vanguard.name': "白骨先鋒",
  'entities.mobs.cx_korreth.name': "元帥科瑞斯",
  'entities.mobs.cx_triad.name': "守死三巨頭",
  'entities.mobs.cx_vrallka.name': "孵母弗拉爾卡",
  'entities.mobs.cx_silkbound.name': "縛絲者",
  'entities.mobs.cx_sethelle.name': "主母瑟賽兒",
  'entities.mobs.cx_rimecore.name': "空心者霜核",
  'entities.mobs.cx_wardens.name': "禦霜守衛",
  'entities.mobs.cx_vorothne.name': "巫妖王沃羅斯尼",
  'entities.npcs.dawn_warbringer_torv.name': "戰禍使托爾夫",
  'entities.npcs.dawn_warbringer_torv.title': "克勞德黎明",
  'entities.npcs.dawn_warbringer_torv.greeting': "缺口終於敞開了，{playerName}，死域正將其亡者傾洩至蒼白邊境之上。率領克勞德黎明攻入克勞德薩拉瑪斯，一區接著一區，將其主宰一一擊倒。",
  'entities.npcs.dawn_loreseeker_miren.name': "尋秘者米倫",
  'entities.npcs.dawn_loreseeker_miren.title': "克勞德黎明",
  'entities.npcs.dawn_loreseeker_miren.greeting': "死域之中有一件比其主宰更為古老的聖物，{playerName}：一根碎裂成片、散落於亡者之間的法杖。將碎片收集起來，我們便能一同重燃哀光。",
  'entities.quests.q_cx_breach.title': "缺口敞開",
  'entities.quests.q_cx_breach.text': "破關鑰已然轉動，{playerName}，克勞德薩拉瑪斯就矗立在我們頭頂之上。其第一區，腐屍大廳，是一座由縫合亡者堆砌而成的屍坑。一路殺至未成者葛羅什面前，將那憎惡之物擊倒，好讓克勞德黎明在內部站穩腳跟。",
  'entities.quests.q_cx_breach.completion': "腐屍大廳已歸我們所有。攻下一區，還有四區。死域不會這麼輕易交出其餘的部分。",
  'entities.quests.q_cx_breach.objectives.0.label': "擊殺未成者葛羅什",
  'entities.quests.q_cx_plague.title': "瘟疫工坊",
  'entities.quests.q_cx_plague.text': "第二區，瘟疫工坊，正釀製著克勞德薩拉瑪斯傾灑於我們土地上的腐毒。瘟疫領主瑪嘉斯看管著那些大缸。終結他，{playerName}，從源頭扼殺這場瘟疫。",
  'entities.quests.q_cx_plague.completion': "大缸已然乾涸。瘟疫工坊再也無法毒害我們的田野。克勞德黎明因此得以喘息。",
  'entities.quests.q_cx_plague.objectives.0.label': "擊殺瘟疫領主瑪嘉斯",
  'entities.quests.q_cx_barracks.title': "守死軍營",
  'entities.quests.q_cx_barracks.text': "死域駐紮著一支衛戍部隊，{playerName}：守死軍營，陣亡的士兵在此為一場永無止盡的戰爭操演。守死三巨頭統領著他們。擊潰三巨頭，這支衛戍部隊也將隨之瓦解。",
  'entities.quests.q_cx_barracks.completion': "三巨頭已然倒下，他們的隊伍四散潰逃。這座軍營再也無力發起反攻。前進，深入黑暗之中。",
  'entities.quests.q_cx_barracks.objectives.0.label': "擊殺守死三巨頭",
  'entities.quests.q_cx_spinning.title': "旋暗之地",
  'entities.quests.q_cx_spinning.text': "第四區從牆到牆都結滿了蛛網，{playerName}：旋暗之地，主母瑟賽兒在此孵育著她那群爬行的子嗣。燒盡蛛網，趁她的蛛群尚未湧出缺口之前終結這位主母。",
  'entities.quests.q_cx_spinning.completion': "瑟賽兒的蛛群已化為灰燼，旋暗之地歸於沉寂。如今唯有那王座還凌駕於你之上。",
  'entities.quests.q_cx_spinning.objectives.0.label': "擊殺主母瑟賽兒",
  'entities.quests.q_cx_throne.title': "空心王座",
  'entities.quests.q_cx_throne.text': "這便是終局了，{playerName}。空心王座座落於死域的中心，其上坐著巫妖王沃羅斯尼，那驅動克勞德薩拉瑪斯的意志。帶上整支團隊。將他擊落，死域便會隨其主宰一同滅亡。",
  'entities.quests.q_cx_throne.completion': "沃羅斯尼已被摧毀，克勞德薩拉瑪斯在蒼白邊境之上墜入黑暗。你率領克勞德黎明直抵死域的核心，並將其連根拔除，{playerName}。這場勝利屬於你，這個組織將會傳頌它。",
  'entities.quests.q_cx_throne.objectives.0.label': "擊殺巫妖王沃羅斯尼",
  'entities.quests.q_cx_legend_1.title': "哀光碎片",
  'entities.quests.q_cx_legend_1.text': "在死域擁有主宰之前，{playerName}，它曾持有一根真光之杖，名為哀光，而當它墜落時，法杖便碎裂了。五片碎片落在克勞德薩拉瑪斯的各區之主手中。他們極少交出碎片，因此你得反覆走訪這座死域許多次。將五片全部帶來給我。",
  'entities.quests.q_cx_legend_1.completion': "五片碎片，每一片皆自不同的亡者之主身上奪來。我能感受到哀光在它們之間悸動。拿著這只尚未點亮的框架；在我們動工期間，它能盛裝這些碎片。",
  'entities.quests.q_cx_legend_1.objectives.0.label': "哀光碎片",
  'entities.quests.q_cx_legend_2.title': "未燃之杖",
  'entities.quests.q_cx_legend_2.text': "框架盛裝著五片碎片，卻仍無法甦醒，{playerName}。哀光需要一顆能讓火焰圍繞燃燒的核心，而如今唯有一物冷得夠徹底、亮得夠耀眼足以勝任：空心之星，鑲嵌在沃羅斯尼自己的胸膛裡。將未燃之杖帶來給我，並為接下來的事做好準備。",
  'entities.quests.q_cx_legend_2.completion': "框架已綁縛妥當、平衡無虞，每一片碎片皆安放得分毫不差。如今它所欠缺的唯有那顆星。你知道它身在何處。",
  'entities.quests.q_cx_legend_2.objectives.0.label': "未燃的哀光之杖",
  'entities.quests.q_cx_legend_3.title': "空心之星",
  'entities.quests.q_cx_legend_3.text': "空心之星在沃羅斯尼的胸膛中燃燒，只要他還屹立著，便絕不會交出它，{playerName}。返回王座，再次終結這位巫妖王，從他的殘骸中扯出那顆星。將它帶來給我，哀光便能終於為克勞德黎明而燃燒。",
  'entities.quests.q_cx_legend_3.completion': "大功告成。空心之星嵌在法杖的頂端，哀光也千百年來首度迸發出純白光芒。拿去吧，{playerName}：哀光，空心黎明之杖。從未有任何一雙手像你這般配得上它。讓它的光芒成為克勞德薩拉瑪斯的黑暗所見的最後一物。",
  'entities.quests.q_cx_legend_3.objectives.0.label': "空心之星",
  'entities.items.mp_feet.name': "亡甲脛靴",
  'entities.items.mp_gloves.name': "亡甲護手",
  'entities.items.mp_waist.name': "亡甲腰帶",
  'entities.items.mp_helmet.name': "亡甲巨盔",
  'entities.items.mp_legs.name': "亡甲腿甲",
  'entities.items.mp_shoulder.name': "亡甲肩鎧",
  'entities.items.mp_chest.name': "亡甲胸甲",
  'entities.items.mp_mh.name': "亡甲掠奪者",
  'entities.items.vw_feet.name': "虛織便鞋",
  'entities.items.vw_gloves.name': "虛織纏手",
  'entities.items.vw_waist.name': "虛織束帶",
  'entities.items.vw_helmet.name': "虛織兜帽",
  'entities.items.vw_legs.name': "虛織護腿",
  'entities.items.vw_shoulder.name': "虛織披肩",
  'entities.items.vw_chest.name': "虛織長袍",
  'entities.items.vw_mh.name': "虛織權杖",
  'entities.items.ng_feet.name': "夜幕踏靴",
  'entities.items.ng_gloves.name': "夜幕緊握",
  'entities.items.ng_waist.name': "夜幕腰帶",
  'entities.items.ng_helmet.name': "夜幕面具",
  'entities.items.ng_legs.name': "夜幕護腿",
  'entities.items.ng_shoulder.name': "夜幕肩飾",
  'entities.items.ng_chest.name': "夜幕外衣",
  'entities.items.ng_mh.name': "夜幕匕首",
  'entities.items.cx_ep_war.name': "死域戰刃",
  'entities.items.cx_ep_mag.name': "死域法杖",
  'entities.items.cx_ep_rog.name': "死域利刺",
  'entities.items.cx_ep_helm.name': "空心王座之冠",
  'entities.items.cx_ep_robe.name': "巫妖王之幛",
  'entities.items.cx_ep_legs.name': "旋暗護腿",
  'entities.items.mournlight_splinter.name': "哀光碎片",
  'entities.items.mournlight_unlit.name': "未燃的哀光之杖",
  'entities.items.hollow_star.name': "空心之星",
  'entities.items.mournlight.name': "哀光，空心黎明之杖",
  'entities.mobs.claudeholme_husk.name': "克勞德霍姆軀殼",
  'entities.mobs.claudeholme_reaver.name': "克勞德霍姆掠殺者",
  'entities.mobs.claudeholme_wraith.name': "空殼怨靈",
  'entities.mobs.plague_acolyte.name': "瘟疫信徒",
  'entities.mobs.bone_construct.name': "骸骨構造體",
  'entities.mobs.ch_gatewarden.name': "守門人",
  'entities.mobs.ch_plaguewright.name': "瘟疫匠賽芙拉",
  'entities.mobs.ch_tollkeeper.name': "收魂者",
  'entities.mobs.ch_maggotlord.name': "蛆蟲領主布魯克",
  'entities.mobs.ch_cantor.name': "頌歌者莫沃",
  'entities.mobs.ch_ashmarshal.name': "灰燼元帥",
  'entities.mobs.ch_bonesmith.name': "鑄骨匠",
  'entities.mobs.ch_veholt.name': "空殼之主維霍特",
  'entities.npcs.dawn_vanguard_kael.name': "先鋒隊長凱爾",
  'entities.npcs.dawn_vanguard_kael.title': "克勞德黎明",
  'entities.npcs.dawn_vanguard_kael.greeting': "克勞德霍姆曾是一座生機盎然的城鎮，{playerName}，直到那艘船的陰影籠罩了它。如今亡者佔據著街道。我們今日就要攻入。",
  'entities.npcs.dawn_reclaimer_sela.name': "回收者賽拉",
  'entities.npcs.dawn_reclaimer_sela.title': "克勞德黎明",
  'entities.npcs.dawn_reclaimer_sela.greeting': "克勞德霍姆的亡者無法被拯救，{playerName}，只能被解脫。取回這座城鎮失去的東西，並助我鑄成那把開啟克勞德薩拉瑪斯本身的鑰匙。",
  'entities.quests.q_ch_breach.title': "克勞德霍姆的突破口",
  'entities.quests.q_ch_breach.text': "廢墟中的傳送門通往克勞德霍姆本身，{playerName}，那是一整座被那艘船在一夜之間殺死的城鎮。一名守門人把守著第一翼。擊破他，黎明就在內部立下了據點。",
  'entities.quests.q_ch_breach.completion': "大門是我們的了。繼續推進，{playerName}。從這裡開始，街道只會愈發險惡。",
  'entities.quests.q_ch_breach.objectives.0.label': "擊殺守門人",
  'entities.quests.q_ch_vats.title': "瘟疫之槽",
  'entities.quests.q_ch_vats.text': "瘟疫匠賽芙拉煉製著讓克勞德霍姆永世不得安息的腐爛之物，{playerName}，就在第二翼深處的槽中。終結她，她的瘟疫之源便會枯竭。",
  'entities.quests.q_ch_vats.completion': "賽芙拉倒下了，她的槽也冷卻下來。第二翼的空氣如今幾乎可以呼吸了。",
  'entities.quests.q_ch_vats.objectives.0.label': "擊殺瘟疫匠賽芙拉",
  'entities.quests.q_ch_toll.title': "靈魂的代價",
  'entities.quests.q_ch_toll.text': "收魂者在第三翼囤積著城鎮的靈魂，{playerName}，一片片地餵給那艘船。將它斬倒，讓那些靈魂得到自由。",
  'entities.quests.q_ch_toll.completion': "收魂者被擊碎了，它所囚禁的靈魂如灰燼般隨風飄散。終於，自由了。",
  'entities.quests.q_ch_toll.objectives.0.label': "擊殺收魂者",
  'entities.quests.q_ch_pit.title': "腐屍之坑",
  'entities.quests.q_ch_pit.text': "第四翼是一處腐屍之坑，{playerName}，蛆蟲領主布魯克便是坑底那座由縫合屍體堆成的山。帶上你全部的隊伍。將那東西放倒。",
  'entities.quests.q_ch_pit.completion': "布魯克終於迸裂開來。如今那坑可以穿越了，{playerName}，不過我建議你穿越時別吸得太深。",
  'entities.quests.q_ch_pit.objectives.0.label': "擊殺蛆蟲領主布魯克",
  'entities.quests.q_ch_chapel.title': "褻瀆的儀式",
  'entities.quests.q_ch_chapel.text': "頌歌者莫沃在古老的禮拜堂中率領亡者進行褻瀆的儀式，{playerName}，那是第五翼。他曾是聖光的祭司。讓他的讚歌沉寂，讓禮拜堂得以安息。",
  'entities.quests.q_ch_chapel.completion': "讚歌已然沉寂。無論那艘船奪去他之前莫沃是何模樣，他如今都已從中解脫。願聖光眷顧他。",
  'entities.quests.q_ch_chapel.objectives.0.label': "擊殺頌歌者莫沃",
  'entities.quests.q_ch_muster.title': "粉碎集結",
  'entities.quests.q_ch_muster.text': "灰燼元帥在第六翼操練著城鎮的亡者民兵，{playerName}，將他們編入隊列。一支亡者大軍是這片荒原最不需要的東西。擊破他們的指揮官。",
  'entities.quests.q_ch_muster.completion': "灰燼元帥倒下了，沒有他，他的隊列便潰散成枯骨。今日沒有任何軍隊能踏出克勞德霍姆。",
  'entities.quests.q_ch_muster.objectives.0.label': "擊殺灰燼元帥",
  'entities.quests.q_ch_forge.title': "讓鑄骨匠沉默",
  'entities.quests.q_ch_forge.text': "鑄骨匠在第七翼將亡者鍛造成構造體，{playerName}，為那艘船製造無窮無盡的骸骨士兵。粉碎他的鍛爐，讓他的鐵錘沉寂。",
  'entities.quests.q_ch_forge.completion': "鐵錘沉寂了，鍛爐也冷卻了。骸骨士兵的隊列在此終結，{playerName}。如今只剩那位死亡之主。",
  'entities.quests.q_ch_forge.objectives.0.label': "擊殺鑄骨匠",
  'entities.quests.q_ch_deathlord.title': "空殼之主",
  'entities.quests.q_ch_deathlord.text': "空殼之主維霍特從最深的一翼統治著克勞德霍姆，{playerName}，他是那艘船的死亡之主化為血肉之軀。他便是這座城鎮永不得安息的緣由。集結你所能召集的最強者並終結他。徹底解放克勞德霍姆。",
  'entities.quests.q_ch_deathlord.completion': "維霍特死了，一片自那艘船到來後克勞德霍姆便不曾有過的寂靜降臨在這城鎮上。你解放了一處黎明早已放棄的地方，{playerName}。我們不會忘記這份功績。",
  'entities.quests.q_ch_deathlord.objectives.0.label': "擊殺空殼之主維霍特",
  'entities.quests.q_ch_streets.title': "亡者之街",
  'entities.quests.q_ch_streets.text': "在你獵殺各翼之主之前，{playerName}，先削減那些堵塞克勞德霍姆街道的軀殼。十五具，為你身後的先鋒隊清出一條路。",
  'entities.quests.q_ch_streets.completion': "十五具軀殼被放倒，街道得以通行。多虧了你，先鋒隊如今可以行動了。",
  'entities.quests.q_ch_streets.objectives.0.label': "擊殺克勞德霍姆軀殼",
  'entities.quests.q_ch_relics.title': "回收的聖物",
  'entities.quests.q_ch_relics.text': "克勞德霍姆曾是一座虔誠的城鎮，{playerName}，它的聖物仍散落在曾守護它們的亡者之間。取回六件。重新受到祝福後，它們在黎明手中能發揮的善，遠勝於在黑暗中腐朽。",
  'entities.quests.q_ch_relics.completion': "六件聖物，每一件都隨著污穢的消退而漸漸溫熱。這座城鎮一點一點地交還它的信仰，{playerName}，而我們也因此武裝得更為精良。",
  'entities.quests.q_ch_relics.objectives.0.label': "回收的聖物",
  'entities.quests.q_ch_attune_1.title': "空殼中的迴響",
  'entities.quests.q_ch_attune_1.text': "你已與納克薩瑪斯共鳴，{playerName}，但克勞德薩拉瑪斯本身是一道更深的門，而開啟它的鑰匙就在克勞德霍姆。一切從維霍特開始：將他斬倒，把他身上的空殼徽記帶來給我。三塊碎片中的第一塊。",
  'entities.quests.q_ch_attune_1.completion': "空殼徽記在我手中嗡鳴，如同被敲響的鐘。三塊之一，{playerName}。突破鑰匙是真實存在的，而我們已經著手了。",
  'entities.quests.q_ch_attune_1.objectives.0.label': "空殼徽記",
  'entities.quests.q_ch_attune_2.title': "受污的聖物",
  'entities.quests.q_ch_attune_2.text': "空殼徽記被瘟疫所污染，{playerName}，唯有這座城鎮自身受祝福的聖物才能淨化它。從克勞德霍姆的亡者那裡為我帶來五件回收的聖物，我便會為鑄造而淨化這枚徽記。",
  'entities.quests.q_ch_attune_2.completion': "五件聖物，環繞在徽記四周，污穢如老皮般從它身上剝落。它如今潔淨了，{playerName}，可以送進鍛爐了。",
  'entities.quests.q_ch_attune_2.objectives.0.label': "回收的聖物",
  'entities.quests.q_ch_attune_3.title': "鑄造突破鑰匙",
  'entities.quests.q_ch_attune_3.text': "徽記需要一個核心來穩固它，{playerName}，而唯有那位死亡之主身懷此物。返回克勞德霍姆，再次將維霍特斬倒，從他的屍體中為我帶來突破核心。第二塊碎片。",
  'entities.quests.q_ch_attune_3.completion': "突破核心，仍帶著維霍特胸膛的寒意。三塊之二，{playerName}。突破鑰匙正在我手中成形。",
  'entities.quests.q_ch_attune_3.objectives.0.label': "突破核心",
  'entities.quests.q_ch_attune_4.title': "灰鐵與骸骨",
  'entities.quests.q_ch_attune_4.text': "突破鑰匙必須以灰鐵包覆，{playerName}，那是鑄骨匠所鍛造的詛咒金屬。從他在克勞德霍姆的鍛爐中為我帶來一錠灰鐵，外殼便算完成了。",
  'entities.quests.q_ch_attune_4.completion': "灰鐵，仍帶著鑄骨匠爐火的餘溫。外殼已鑄成，{playerName}。如今只剩那位死亡之主的王冠，用以為鑰匙加冕。",
  'entities.quests.q_ch_attune_4.objectives.0.label': "灰鐵錠",
  'entities.quests.q_ch_attune_5.title': "通往克勞德薩拉瑪斯的鑰匙",
  'entities.quests.q_ch_attune_5.text': "只剩一塊碎片，{playerName}：取自維霍特額前的空殼王冠。最後一次返回克勞德霍姆，奪取那頂王冠，我便會將它安置在突破鑰匙之巔。有了它，克勞德薩拉瑪斯本身將向黎明敞開，而你將帶領我們穿越。",
  'entities.quests.q_ch_attune_5.completion': "完成了。黎明突破鑰匙屬於你了，{playerName}，徽記、核心與王冠盡數包覆於灰鐵之中。當克勞德黎明攻入克勞德薩拉瑪斯時，你將執掌那把開啟它的鑰匙。這個組織再無比你更偉大的勇士。準備就緒吧。突破將至。",
  'entities.quests.q_ch_attune_5.objectives.0.label': "維霍特的空殼王冠",
  'entities.items.pw_feet.name': "瘟疫守衛者的脛甲",
  'entities.items.pw_gloves.name': "瘟疫守衛者的護手",
  'entities.items.pw_waist.name': "瘟疫守衛者的腰帶",
  'entities.items.pw_helmet.name': "瘟疫守衛者的巨盔",
  'entities.items.pw_legs.name': "瘟疫守衛者的腿甲",
  'entities.items.pw_shoulder.name': "瘟疫守衛者的護肩",
  'entities.items.pw_chest.name': "瘟疫守衛者的胸甲",
  'entities.items.pw_mh.name': "瘟疫守衛者的劈刀",
  'entities.items.hm_feet.name': "空殼祕法師的軟靴",
  'entities.items.hm_gloves.name': "空殼祕法師的手綁帶",
  'entities.items.hm_waist.name': "空殼祕法師的束繩",
  'entities.items.hm_helmet.name': "空殼祕法師的兜帽",
  'entities.items.hm_legs.name': "空殼祕法師的長褲",
  'entities.items.hm_shoulder.name': "空殼祕法師的披肩",
  'entities.items.hm_chest.name': "空殼祕法師的長袍",
  'entities.items.hm_mh.name': "空殼祕法師的權杖",
  'entities.items.as_feet.name': "灰燼潛行者的踏靴",
  'entities.items.as_gloves.name': "灰燼潛行者的握套",
  'entities.items.as_waist.name': "灰燼潛行者的皮帶",
  'entities.items.as_helmet.name': "灰燼潛行者的面具",
  'entities.items.as_legs.name': "灰燼潛行者的護腿",
  'entities.items.as_shoulder.name': "灰燼潛行者的肩甲",
  'entities.items.as_chest.name': "灰燼潛行者的外衣",
  'entities.items.as_mh.name': "灰燼潛行者的匕首",
  'entities.items.veholt_war.name': "維霍特的空殼之刃",
  'entities.items.veholt_mag.name': "維霍特的死亡低語",
  'entities.items.veholt_rog.name': "維霍特的空殼之牙",
  'entities.items.claudeholme_relic.name': "回收的聖物",
  'entities.items.veholt_sigil.name': "空殼徽記",
  'entities.items.breach_core.name': "突破核心",
  'entities.items.ash_iron.name': "灰鐵錠",
  'entities.items.hollow_crown.name': "維霍特的空殼王冠",
  'entities.items.breachkey_dawn.name': "黎明突破鑰匙",
  'hudChrome.loadingTips.map': "按 M 開啟世界地圖，查看任務目標。",
  'hudChrome.loadingTips.quests': "與頭頂有 ! 的村民交談來接取任務。",
  'hudChrome.loadingTips.inspect': "右鍵點擊其他玩家可查看其裝備。",
  'hudChrome.loadingTips.camera': "按住滑鼠右鍵旋轉視角，滾動滾輪縮放。",
  'hudChrome.loadingTips.chat': "輸入 /join world 與全伺服器聊天，或輸入 /join lfg 尋找隊伍。",
  'hudChrome.loadingTips.rested': "在城鎮休息可累積休息經驗，回來後升級更快。",
  'hudChrome.loadingTips.talents': "升級時用 (N) 分配天賦點，打造你的流派。",
  'hudChrome.loadingTips.vendor': "把雜物賣給商人；把稀有物品掛到世界市場賣給其他玩家。",
  'hudChrome.loadingTips.group': "組隊能讓強敵和地下城更輕鬆。邀請你遇到的玩家吧！",
  'hudChrome.loadingTips.classes': "九個職業各有不同的玩法。多試幾個，找到你最喜歡的。",
  ...
  'guide.controls.controllerBody': '手把同樣可用，且預設即開啟手把支援。左搖桿負責移動，右搖桿控制鏡頭，正面按鍵與肩鍵則涵蓋你的技能、跳躍與互動。開啟任何視窗都會喚出畫面上的指標，供你操作選單。你可以在選項中的手把設定裡重新配置按鍵，並調整搖桿盲區、鏡頭速度、震動以及反轉視角。',
  ...
  'guide.questsPage.sideTempleBody': '高峰之上一座高山湖泊中，一道蒼白光芒構成的門扉，通往一座沉沒的神殿，那裡有一群溺亡的邪教徒仍在歌唱。它那條短短的任務鏈獨立於主線故事之外，是一樁自成一體的謎團，獻給每一個攀上湖岸、讀懂刻在岩石上的警語，並下去一探那些警語究竟所為何來的人。',
  ...
  'guide.delvesPage.whatBody': '秘探是一座小型的副本地城，專為你與至多一名盟友打造，是一份不會受到打擾的獨立複本。你從世界中由秘探看守人看管的看板啟程，下到其中，一路打穿少數幾個房間，並在單一守護者面前作結。旅程短促且設計來反覆挑戰，因此每當開放世界無事可做時，秘探都是一份可靠的進度來源。',
  ...
  'guide.delvesPage.companionBody': '秘探會派一名同伴與你一同下去，因此單人旅程絕不會毫無勝算。她會在你身旁作戰，而當你在旅程之間投注於她，她也會穩定地變強，直到每趟探索能將一名瀕死的隊友從鬼門關前拉回一次。她在這趟秘探中歸你所有，並在旅程間隙於看板旁等候。',
  ...
  'guide.gear.setsBody': '最稀有的護甲以成套的系列出現，數件裝備經過設計，使其外觀與戰鬥表現渾然一體。同時穿上足夠多的同系列裝備，套裝便會啟動，在每件裝備本身的屬性之上額外賦予加成，而你穿得越多，效果就越強。這些裝備掉落自接近等級上限的最艱難團隊內容，因此追求一整套裝是經典的終局目標。',
