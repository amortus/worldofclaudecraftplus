...
// Rebuild the bar for a switched talent loadout. A saved loadout's bar only ever
// records ability ids (the caller's save mapping in hud.ts strips item shortcuts
