...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    ...
    "mobs": {
      ...
      "blighted_husk": {
        "name": "Зараженная оболочка"
      },
      "ashen_ghoul": {
        "name": "Пепельный вурдалак"
      },
      "plague_crawler": {
        "name": "Чумной ползун"
      },
      "corrupted_acolyte": {
        "name": "Оскверненный послушник"
      },
      "bone_reaver": {
        "name": "Костяной разоритель"
      },
      "wraithling": {
        "name": "Курганный призрачок"
      },
      "rotting_behemoth": {
        "name": "Гниющий бегемот"
      },
      "plaguebringer_zealot": {
        "name": "Чумоносный фанатик"
      },
      "naxx_deathguard": {
        "name": "Стражник смерти Naxxramas"
      },
      "morthax_the_hollow": {
        "name": "Мортакс Пустотелый"
      },
      "gravelord_oss": {
        "name": "Могильный лорд Осс"
      },
      "blighted_stag": {
        "name": "Порченый олень"
      },
    ...
    "npcs": {
      ...
      "dawn_commander_sera": {
        "name": "Командир Сера",
        "title": "Рассвет Клода",
        "greeting": "Держи строй, {className}. Эта парящая гробница, Claudexxaramas, обескровила всю эту землю до серости. Рассвет Клода вернет ее назад, душа за душой."
      },
      "dawn_chaplain_orin": {
        "name": "Капеллан Орин",
        "title": "Рассвет Клода",
        "greeting": "Свет еще достигает этих мест, {playerName}, хоть и едва-едва. Помоги мне выходить умирающих и сломить чуму, что корабль изливает на нас."
      },
      "dawn_quartermaster_henning": {
        "name": "Интендант Хеннинг",
        "title": "Рассвет Клода",
        "greeting": "Сталь и вера, {playerName}, вот все, что я могу дать. Заслужи доверие Рассвета, и склад интенданта откроется тебе, часть за частью."
      },
      "dawn_scout_irelle": {
        "name": "Разведчица Ирелла",
        "title": "Рассвет Клода",
        "greeting": "Я нанесла на карту мертвые дороги так далеко на север, как только посмела, {className}. Чем ближе к Бледным пределам, тем громче шепчет корабль. Смотри под ноги."
      },
      "dawn_archivist_vael": {
        "name": "Архивариус Ваэль",
        "title": "Рассвет Клода",
        "greeting": "Каждый осколок этого некрополя, что я могу изучить, это трещина, которую мы однажды сумеем расширить, {playerName}. Принеси мне то, что несут мертвецы, и мы вместе спланируем прорыв."
      },
      "dawn_vanguard_kael": {
        "name": "Капитан авангарда Каэль",
        "title": "Рассвет Клода",
        "greeting": "Когда-то Клодхольм был живым городом, {playerName}, пока на него не пала тень корабля. Теперь его мёртвые держат улицы. Сегодня мы проломим его стены."
      },
      "dawn_reclaimer_sela": {
        "name": "Возвращающая Села",
        "title": "Рассвет Клода",
        "greeting": "Мёртвых Клодхольма уже не спасти, {playerName}, их можно лишь освободить. Верни то, что потерял город, и помоги мне выковать ключ, что отворит сам Клодксарамас."
      },
      "dawn_warbringer_torv": {
        "name": "Вестник Войны Торв",
        "title": "Рассвет Клода",
        "greeting": "Брешь наконец открыта, {playerName}, и некрополь выплёскивает своих мертвецов на Бледный Предел. Веди Рассвет в Клодекссарамас, квартал за кварталом, и низвергни его владык."
      },
      "dawn_loreseeker_miren": {
        "name": "Искательница Знаний Мирен",
        "title": "Рассвет Клода",
        "greeting": "В некрополе есть реликвия старше его владыки, {playerName}: посох, расколотый на осколки и рассеянный среди мертвецов. Собери их, и мы вместе вновь зажжём Скорбный Свет."
      },
      "dawn_huntsman_varik": {
        "name": "Охотник Варик",
        "title": "Рассвет Клода",
        "greeting": "Порча добралась до зверья, {playerName}. Олени южной пустоши встают с зелёным огнём в глазах, а лисы кормятся тем, что остаётся после них. Я охочусь на них, чтобы порча не расползалась дальше. Одолжи мне свой лук или свой клинок."
      },
      "weirwarden_ondrey": {
    ...
    "quests": {
      ...
      "q_aw_arrival": {
        "title": "Пепел и предзнаменования",
        "text": "Добро пожаловать в Могильную стражу, {playerName}, в то немногое, что оставила нам зараза. Оболочки павших скребутся в наши стены каждую ночь. Уложи восьмерых из них, чтобы мои солдаты могли спать, и Рассвет Клода сочтет тебя будущим другом.",
        "completion": "На восемь ужасов у ворот меньше. У тебя твердая рука, {playerName}. Рассвет помнит тех, кто стоит с нами.",
        "objectives": {
          "0": {
            "label": "Зараженная оболочка повержена"
          }
        }
      },
      "q_aw_husks": {
        "title": "Ходячая зараза",
        "text": "Оболочки не безмозглы, {playerName}, они собираются вместе, прощупывают наши рубежи. Истреби еще двенадцать, прежде чем они выведают, где мы всего слабее. Возьми эти башмаки для ходьбы: пустоши беспощадны к обуви.",
        "completion": "Хорошо. Каждая сожженная тобой оболочка не поднимется этой ночью снова.",
        "objectives": {
          "0": {
            "label": "Зараженная оболочка повержена"
          }
      ...
      "q_aw_ghouls": {
        "title": "Дикий голод",
        "text": "Пепельные вурдалаки охотятся стаями там, на Костяных полях, быстрые и бешеные. Они уже утащили двоих моих разведчиков. Проредь их, десятка должно хватить, чтобы разбить стаю, прежде чем они осмелеют настолько, чтобы броситься на ворота.",
        "completion": "Стаи рассеяны. Мои разведчики снова могут обходить Костяные поля, благодаря тебе.",
        "objectives": {
          "0": {
            "label": "Пепельный вурдалак повержен"
          }
        }
      },
      "q_aw_crawlers": {
        "title": "Расползающаяся хворь",
        "text": "Чумные ползуны несут заразу в своем укусе, {playerName}, и плодятся в грязи Тихозерья. Убей десять из них. Где они ползут, туда следует и хворь, а у меня и так уже слишком много занятых коек.",
        "completion": "Обереги на койках продержатся теперь немного дольше. Свет благодарит тебя, даже когда я об этом забываю.",
        "objectives": {
          "0": {
            "label": "Чумной ползун повержен"
          }
        }
      },
      "q_aw_samples": {
        "title": "Зараженные образцы",
        "text": "Чтобы исцелить заразу, я должен сперва ее понять. Оболочки и ползуны пропитаны ею насквозь, принеси мне шесть зараженных образцов их оскверненной плоти и обращайся с ними бережно. Скверне нет дела до того, чью кровь она портит.",
        "completion": "Шесть образцов, и каждый хуже предыдущего. Порча... упорядочена. Намеренна. Это не природная чума, {playerName}.",
        "objectives": {
          "0": {
            "label": "Зараженный образец"
          }
        }
      },
      "q_aw_acolytes": {
        "title": "Голоса корабля",
        "text": "Живые люди теперь преклоняют колени перед Claudexxaramas, {playerName}, оскверненные послушники, что разносят его волю по пустошам песнопениями. Их больше не спасти. Заставь умолкнуть десятерых из них. Возьми эти налокотники: до конца этого дела ты заслужишь и кое-что похуже.",
        "completion": "Песнопения сбиваются. Что бы ни строил корабль, ты стоил ему десяти послушных глоток.",
        "objectives": {
          "0": {
            "label": "Оскверненный послушник повержен"
          }
        }
      },
      "q_aw_orders": {
        "title": "Приказы свыше",
        "text": "Послушники носят писаные приказы, {playerName}, корабль говорит, а они переписывают. Сруби еще восьмерых и принеси мне четыре свитка этих приказов. Я хочу знать, что велит Claudexxaramas, прежде чем это велят и нам.",
        "completion": "От этих письмен мурашки бегут по коже, стоит лишь взглянуть. Но это и впрямь приказы: собирать мертвых, готовить Бледные пределы. Они к чему-то готовятся.",
        "objectives": {
          "0": {
            "label": "Оскверненный послушник повержен"
          },
          "1": {
            "label": "Оскверненные приказы"
          }
        }
      },
      "q_aw_reavers": {
        "title": "Костяные поля",
        "text": "Костяные разорители, это ходячие оружейные, {playerName}, старые солдаты, перекованные в клинки корабля. Разбей двенадцать из них на Костяных полях. Каждый рассеянный тобой разоритель, это сталь, что больше никогда не обрушится на Рассвет.",
        "completion": "Двенадцать разорителей разнесены в щепки. Такая добыча держит мой горн зажженным. Отлично сработано.",
        "objectives": {
          "0": {
            "label": "Костяной разоритель повержен"
          }
        }
      },
      "q_aw_wraiths": {
        "title": "Пустые курганы",
        "text": "Старые курганы к северу отсюда пробудились, {playerName}. Из могил поднимаются призрачки, холодные твари, что выпивают тепло из живых. Упокой десять из них. Мертвые этих пустошей заслуживают лучшего, чем служить тому кораблю.",
        "completion": "Десять душ возвращены во тьму. Я прочел молитву над каждой, как ты и описывал. Это малая милость, но она наша.",
        "objectives": {
          "0": {
            "label": "Курганный призрачок повержен"
          }
        }
      },
      "q_aw_relics": {
        "title": "Освященные реликвии",
        "text": "В курганах хранятся реликвии старой веры, когда-то освященные, ныне оскверненные прикосновением призрачков. Верни пять из могил, {playerName}. Очищенные и заново благословленные, они защитят койки куда лучше моих слабеющих молитв.",
        "completion": "Пять реликвий, и каждая теплеет в моих руках, когда скверна отступает. Свет не покинул это место. Его лишь нужно было принести домой.",
        "objectives": {
          "0": {
            "label": "Оскверненная реликвия"
          }
        }
      },
      "q_aw_hold": {
        "title": "Оборона Могильной стражи",
        "text": "Скажу прямо, {playerName}: мы сдаем позиции. Разорители давят на Костяные поля все сильнее с каждой ночью. Мне нужно разбить еще четырнадцать из них, чтобы выкупить гарнизону неделю передышки. Может ли Рассвет рассчитывать на тебя?",
        "completion": "Неделя. Ты выкупил нам неделю. Я не растрачу ее впустую, и не забуду, кто ее заслужил.",
        "objectives": {
          "0": {
            "label": "Костяной разоритель повержен"
          }
      ...
      "q_aw_behemoth": {
        "title": "Гниющий бегемот",
        "text": "Что-то огромное движется по Тихозерью, {playerName}, бегемот из сшитой и гниющей мертвечины, достаточно громадный, чтобы пройти сквозь нашу стену, как сквозь плетень. Возьми спутника или двух и уложи его, прежде чем он доберется до Могильной стражи. Этот пояс поможет тебе сносить удары.",
        "completion": "Ты повалил эту гору мяса. Я даже отсюда почувствовал, как перестала дрожать земля. Рассвет в долгу перед тобой за это.",
        "objectives": {
          "0": {
            "label": "Гниющий бегемот повержен"
          }
        }
      },
      "q_aw_zealots": {
        "title": "Чумоносцы",
        "text": "Чумоносные фанатики засевают подступы к Бледным пределам вспышками гнили, {playerName}, и исцеляют друг друга быстрее, чем одинокий клинок успевает их свалить. Убей восьмерых. Бей сильно, бей разом и не давай им сомкнуться, чтобы исцелиться.",
        "completion": "Восемь фанатиков, и гниль, что они сеяли, гибнет вместе с ними. Подступ снова проходим, едва-едва.",
        "objectives": {
          "0": {
            "label": "Чумоносный фанатик повержен"
          }
        }
      },
      "q_aw_deathguard": {
        "title": "Стражи корабля",
        "text": "Стражники смерти Naxxramas, это собственные стражи корабля, {playerName}, отборные мертвецы в черных латах, расставленные там, где Claudexxaramas висит ниже всего. Разбей десять из них. Мне нужно знать, способен ли Рассвет сражаться в самой тени некрополя. Этот шлем некогда принадлежал стражнику смерти, надень его против них.",
        "completion": "Десять стражей повержены, в самой тени корабля. Значит, это возможно. Значит, однажды мы сможем перенести бой ВВЕРХ. Ты показал мне это, {playerName}.",
        "objectives": {
          "0": {
            "label": "Стражник смерти Naxxramas повержен"
          }
        }
      },
      "q_aw_morthax": {
        "title": "Пустотелый лорд",
        "text": "Один из наших пал в Пустых курганах в прошлом сезоне, рыцарь по имени Мортакс. Корабль поднял его, {playerName}, и теперь Мортакс Пустотелый охотится на людей, которых когда-то вел за собой. Найди его. Покончи с ним. Принеси мне его сердце, чтобы я знал: тварь, носящая его лицо, и впрямь сгинула.",
        "completion": "Холодное. Сердце холодно как камень и пусто, как имя, что ему дали. Покойся, Мортакс. Ты служил Рассвету до конца, и за его пределом.",
        "objectives": {
          "0": {
            "label": "Пустотелое сердце"
          }
        }
      },
      "q_aw_pale_reach": {
        "title": "В Бледные пределы",
        "text": "Бледные пределы, это худшее из всего, {playerName}, голая земля прямо под заякоренным кораблем, кишащая стражниками смерти. Мне в одиночку ее не нанести на карту. Прорежь мне путь: уложи восемь стражников смерти Naxxramas, пока я зарисовываю землю за твоей спиной.",
        "completion": "Готово, все Пределы наконец нанесены на карту, каждый дозор и каждый пилон. Архивариус Ваэль захочет это увидеть. И командир тоже, когда придет день выступить на корабль.",
        "objectives": {
          "0": {
            "label": "Стражник смерти Naxxramas повержен"
          }
      ...
      "q_aw_ritual": {
        "title": "Сорви ритуал",
        "text": "Фанатики творят ритуал на Бледных пределах, чтобы притянуть Claudexxaramas еще ниже, {playerName}. Каждый несет ритуальный фокус, удерживающий обряд. Забери четыре из них и убей шестерых фанатиков по ходу дела: разорви якоря, и ритуал застопорится.",
        "completion": "Фокусы гаснут, едва покидают Пределы. Четыре якоря перерезаны. Сегодня корабль не висит ниже, и это победа, какой бы малой она ни была.",
        "objectives": {
          "0": {
            "label": "Ритуальный фокус"
          },
          "1": {
            "label": "Чумоносный фанатик повержен"
          }
      ...
      "q_aw_attune_1": {
        "title": "Отзвуки Claudexxaramas",
        "text": "Чтобы прорваться в некрополь, мы должны сперва его понять, {playerName}. Его стражи несут обломки его корпуса, мертвый металл, что все еще гудит в ритме корабля. Принеси мне три обломка корабля со стражников смерти, и я начну постигать песнь Naxxramas.",
        "completion": "Они звучат в лад, вслушайся. Три ноты одной и той же погребальной песни. Имей я довольно таких, архивариус, я смог бы нанести на карту путь ВНУТРЬ. Вот как мы прорвемся.",
        "objectives": {
          "0": {
            "label": "Обломок корабля"
          }
        }
      },
      "q_aw_gravelord": {
        "title": "Могильный лорд Осс",
        "text": "Могильный лорд Осс, это рука корабля на земле, {playerName}, наместник, что приковывает всю заразу к Бледным пределам. Собери своих сильнейших спутников: это бой не для одного и даже не для троих. Сруби Могильного лорда, и сами пустоши, быть может, начнут исцеляться.",
        "completion": "Осс мертв, и взгляни: пепел в Пределах уже бледнеет к серо-зеленому. Ты убил не просто наместника, {playerName}. Ты показал Рассвету, что Claudexxaramas можно ранить.",
        "objectives": {
          "0": {
            "label": "Могильный лорд Осс повержен"
          }
        }
      },
      "q_aw_attunement": {
        "title": "Прорыв в Naxxramas",
        "text": "Со смертью Осса и сломленным якорем Могильного лорда корабль висит уязвимый, {playerName}. Это тот самый миг. Принеси мне еще пять обломков корабля, и я выкую из них Печать Рассвета, твою настройку на сам Naxxramas. Когда Рассвет Клода наконец штурмом возьмет этот некрополь, носители печатей поведут прорыв, и приступ будет стоить нам вдвое меньше крови и стали, чем должен.",
        "completion": "Готово. Печать Рассвета твоя, {playerName}, доказательство для каждой души в этом ордене, что ты готов к некрополю. Когда мы выступим на Claudexxaramas, ты пойдешь во главе. Превознесенный среди нас, настроенный на прорыв. Рассвет не мог бы пожелать более истинного защитника.",
        "objectives": {
          "0": {
            "label": "Обломок корабля"
          }
      ...
      "q_aw_rotting_herd": {
        "title": "Гниющее стадо",
        "text": "Олени южной пустоши больше не олени, {playerName}. Порча захватила всё стадо, и теперь они бросаются на всё, что дышит, с рогов капает зелёная мерзость. Проредь их, восьмерых хватит, чтобы сломить стадо, прежде чем они забредут на север к Могильному дозору.",
        "completion": "На восемь гниющих тварей в пустоши меньше. Сегодня стадо не дойдёт до лагеря. Ты хорошо охотишься, {playerName}.",
        "objectives": {
          "0": {
            "label": "Порченые олени убиты"
          }
        }
      },
      "q_aw_ash_scavengers": {
        "title": "Падальщики пепла",
        "text": "Где падают олени, туда приходят лисы, {playerName}. Мелкие гниющие падальщики, что разносят порчу всё шире с каждой тушей, которую утаскивают. Прикончи восьмерых из них и не дай порче ползти дальше.",
        "completion": "Падальщики разогнаны. Хорошо. Каждый убитый тобой это миля пустоши, что останется чистой чуть дольше.",
        "objectives": {
          "0": {
            "label": "Гниющие лисицы убиты"
          }
        }
      },
      "q_aw_corrupt_sample": {
        "title": "Семена гнили",
        "text": "Я хочу знать, как глубоко порча проникла в этих зверей, {playerName}. Принеси мне шесть осквернённых рогов с оленей, зелёная мерзость хуже всего гноится в кости, и я прочту, как быстро она расползается. Если стадо уже потеряно, Рассвет должен знать об этом.",
        "completion": "Шесть рогов, и каждый прогнил до самой сердцевины. Порча уже в их костном мозге, {playerName}. Стадо не спасти, его можно лишь добить. Но Рассвет знает, с чем столкнулся, а это дороже чистого убийства.",
        "objectives": {
          "0": {
            "label": "Осквернённый рог"
          }
        }
      },
      "q_ch_breach": {
        "title": "Прорыв в Клодхольм",
        "text": "Портал в руинах открывается прямо в Клодхольм, {playerName}, в целый город, что корабль убил за одну ночь. Привратник держит первое крыло. Сломи его, и у Рассвета будет опора внутри.",
        "completion": "Врата наши. Продвигайся дальше, {playerName}. Дальше улицы становятся лишь хуже.",
        "objectives": {
          "0": {
            "label": "Привратник убит"
          }
        }
      },
      "q_ch_vats": {
        "title": "Чумные чаны",
        "text": "Чумодел Севра варит гниль, что держит Клодхольм мёртвым, {playerName}, в чанах глубоко во втором крыле. Покончи с ней, и колодцы её чумы иссякнут.",
        "completion": "Севра пала, и её чаны остыли. Воздух во втором крыле теперь почти пригоден для дыхания.",
        "objectives": {
          "0": {
            "label": "Чумодел Севра убита"
          }
        }
      },
      "q_ch_toll": {
        "title": "Мзда душ",
        "text": "Сборщик мзды копит души города в третьем крыле, {playerName}, скармливая их кораблю кусок за куском. Сруби его и дай этим душам свободу.",
        "completion": "Сборщик мзды сломлен, и души, что он держал, рассеиваются, словно пепел на ветру. Наконец-то свободны.",
        "objectives": {
          "0": {
            "label": "Сборщик мзды убит"
          }
        }
      },
      "q_ch_pit": {
        "title": "Падальная яма",
        "text": "Четвёртое крыло, это падальная яма, {playerName}, а Червь-владыка Брулк, это гора сшитых мертвецов на её дне. Возьми всю свою группу. Уложи эту тварь.",
        "completion": "Брулк наконец разрывается на части. Теперь яму можно пройти, {playerName}, хоть я бы и не дышал глубоко, пока ты это делаешь.",
        "objectives": {
          "0": {
            "label": "Червь-владыка Брулк убит"
          }
        }
      },
      "q_ch_chapel": {
        "title": "Нечестивые обряды",
        "text": "Канторе Мовл ведёт мёртвых в нечестивых обрядах в старой часовне, {playerName}, в пятом крыле. Когда-то он был жрецом Света. Заставь умолкнуть его гимн и дай часовне покой.",
        "completion": "Гимн умолк. Чем бы ни был Мовл до того, как корабль забрал его, теперь он от этого свободен. Да хранит его Свет.",
        "objectives": {
          "0": {
            "label": "Канторе Мовл убит"
          }
        }
      },
      "q_ch_muster": {
        "title": "Сорвать сбор",
        "text": "Пепельный маршал муштрует мёртвое ополчение города в шестом крыле, {playerName}, сводя их в ряды. Армия мёртвых, это последнее, что нужно этим пустошам. Сломи их командира.",
        "completion": "Пепельный маршал пал, и без него его ряды осыпаются костями. Сегодня из Клодхольма не выйдет ни одна армия.",
        "objectives": {
          "0": {
            "label": "Пепельный маршал убит"
          }
        }
      },
      "q_ch_forge": {
        "title": "Заставь умолкнуть Костокузнеца",
        "text": "Костокузнец куёт из мёртвых конструкции в седьмом крыле, {playerName}, бесконечную вереницу костяных солдат для корабля. Разбей его горн и заставь умолкнуть его молот.",
        "completion": "Молот умолк, и горн остыл. Вереница костяных солдат обрывается здесь, {playerName}. Остался лишь повелитель смерти.",
        "objectives": {
          "0": {
            "label": "Костокузнец убит"
          }
        }
      },
      "q_ch_deathlord": {
        "title": "Полый лорд",
        "text": "Лорд Вехолт Полый правит Клодхольмом из самого глубокого крыла, {playerName}, повелитель смерти корабля, обретший плоть. Из-за него город никогда не упокоится. Собери сильнейших, кого сможешь, и покончи с ним. Освободи Клодхольм навсегда.",
        "completion": "Вехолт мёртв, и над Клодхольмом воцаряется тишина, какой город не знал с тех пор, как явился корабль. Ты освободил место, на котором Рассвет уже поставил крест, {playerName}. Мы этого не забудем.",
        "objectives": {
          "0": {
            "label": "Лорд Вехолт Полый убит"
          }
        }
      },
      "q_ch_streets": {
        "title": "Улицы мёртвых",
        "text": "Прежде чем охотиться на владык крыльев, {playerName}, проредь оболочки, что забили улицы Клодхольма. Пятнадцать из них, чтобы расчистить путь для авангарда за твоей спиной.",
        "completion": "Пятнадцать оболочек уложено, и улицы стали проходимы. Теперь авангард может двигаться, благодаря тебе.",
        "objectives": {
          "0": {
            "label": "Оболочка Клодхольма убита"
          }
        }
      },
      "q_ch_relics": {
        "title": "Возвращённые реликвии",
        "text": "Когда-то Клодхольм был городом верных, {playerName}, и его реликвии всё ещё лежат среди мёртвых, что некогда их хранили. Верни шесть. Заново освящённые, они принесут больше пользы в руках Рассвета, чем гния во тьме.",
        "completion": "Шесть реликвий, и каждая теплеет по мере того, как сходит скверна. Город отдаёт свою веру понемногу, {playerName}, а мы становимся лучше вооружены.",
        "objectives": {
          "0": {
            "label": "Возвращённая реликвия"
          }
        }
      },
      "q_ch_attune_1": {
        "title": "Эхо в Полом",
        "text": "Ты приобщён к Наксрамасу, {playerName}, но сам Клодксарамас, это дверь куда глубже, и ключ к ней лежит в Клодхольме. Всё начинается с Вехолта: сруби его и принеси мне Полую печать, что он носит. Первая из трёх частей.",
        "completion": "Полая печать гудит в моей руке, словно ударенный колокол. Одна часть из трёх, {playerName}. Ключ прорыва реален, и мы начали его создавать.",
        "objectives": {
          "0": {
            "label": "Полая печать"
          }
      ...
      "q_ch_attune_2": {
        "title": "Осквернённые реликвии",
        "text": "Полая печать осквернена чумой, {playerName}, и лишь благословенные реликвии самого города очистят её. Принеси мне пять возвращённых реликвий от мёртвых Клодхольма, и я очищу печать для ковки.",
        "completion": "Пять реликвий, уложенных вокруг печати, и скверна сходит с неё, словно старая кожа. Теперь она чиста, {playerName}, и готова к горну.",
        "objectives": {
          "0": {
            "label": "Возвращённая реликвия"
          }
      ...
      "q_ch_attune_3": {
        "title": "Ковка ключа прорыва",
        "text": "Печати нужно ядро, чтобы закрепить её, {playerName}, и лишь повелитель смерти носит такое. Вернись в Клодхольм, сруби Вехолта снова и принеси мне Ядро прорыва из его трупа. Вторая часть.",
        "completion": "Ядро прорыва, всё ещё холодное из груди Вехолта. Две части из трёх, {playerName}. Ключ прорыва обретает форму в моих руках.",
        "objectives": {
          "0": {
            "label": "Ядро прорыва"
          }
      ...
      "q_ch_attune_4": {
        "title": "Пепельное железо и кость",
        "text": "Ключ прорыва должен быть закован в пепельное железо, {playerName}, проклятый металл, с которым работает Костокузнец. Принеси мне слиток пепельного железа из его горна в Клодхольме, и оправа будет готова.",
        "completion": "Пепельное железо, всё ещё тёплое от огня Костокузнеца. Оправа отлита, {playerName}. Остаётся лишь корона повелителя смерти, чтобы увенчать ключ.",
        "objectives": {
          "0": {
            "label": "Слиток пепельного железа"
          }
        }
      },
      "q_ch_attune_5": {
        "title": "Ключ к Клодксарамасу",
        "text": "Остаётся одна часть, {playerName}: Полая корона с самого чела Вехолта. Вернись в Клодхольм в последний раз, забери корону, и я водружу её на ключ прорыва. С ним сам Клодксарамас отворится Рассвету, и ты поведёшь нас сквозь него.",
        "completion": "Свершилось. Ключ прорыва Рассвета твой, {playerName}, печать, ядро и корона, всё закованное в пепельное железо. Когда Рассвет Клода возьмёт штурмом Клодксарамас, ты понесёшь ключ, что отворит его. Нет защитника величественнее для этого ордена. Будь наготове. Прорыв близится.",
        "objectives": {
          "0": {
            "label": "Полая корона Вехолта"
          }
        }
      },
      "q_cx_breach": {
        "title": "Брешь открывается",
        "text": "Ключ Бреши повернулся, {playerName}, и Клодекссарамас распахнулся над нами. Его первый квартал, Падальные Залы, это смрадная яма сшитых мертвецов. Прорубись к Грошу Несотворённому и низвергни эту мерзость, чтобы Рассвет смог закрепиться внутри.",
        "completion": "Падальные Залы наши. Один квартал взят, осталось четыре. Некрополь не уступит остальное так легко.",
        "objectives": {
          "0": {
            "label": "Грош Несотворённый сражён"
          }
        }
      },
      "q_cx_plague": {
        "title": "Чумные Цеха",
        "text": "Второй квартал, Чумные Цеха, варит гниль, которой Клодекссарамас осыпает наши земли. Маггат Чумной Владыка следит за его чанами. Покончи с ним, {playerName}, и задуши чуму у самого истока.",
        "completion": "Чаны опустели. Чумные Цеха больше не отравят ни одного поля. Рассвету дышится легче от этого.",
        "objectives": {
          "0": {
            "label": "Маггат Чумной Владыка сражён"
          }
        }
      },
      "q_cx_barracks": {
        "title": "Казармы Смертной Стражи",
        "text": "Некрополь держит гарнизон, {playerName}: Казармы Смертной Стражи, где павшие солдаты муштруются для войны, что не кончается никогда. Триада Смертостража ведёт их. Сокруши Триаду, и гарнизон рухнет вместе с ней.",
        "completion": "Триада пала, и её ряды рассеяны. Казармы не соберут контратаки. Вперёд, во тьму.",
        "objectives": {
          "0": {
            "label": "Триада Смертостража сражена"
          }
        }
      },
      "q_cx_spinning": {
        "title": "Прядущая Тьма",
        "text": "Четвёртый квартал заткан паутиной от стены до стены, {playerName}: Прядущая Тьма, где Матрона Сетелле высиживает своих ползучих детей. Выжги паутину и покончи с Матроной, пока её выводок не захлестнул брешь.",
        "completion": "Выводок Сетелле обращён в пепел, и Прядущая Тьма затихла. Теперь над тобой остаётся лишь трон.",
        "objectives": {
          "0": {
            "label": "Матрона Сетелле сражена"
          }
        }
      },
      "q_cx_throne": {
        "title": "Полый Трон",
        "text": "Это конец всему, {playerName}. Полый Трон стоит в сердце некрополя, и на нём Архилич Воротне, воля, что движет Клодекссарамасом. Возьми весь рейд. Низвергни его, и некрополь умрёт вместе со своим владыкой.",
        "completion": "Воротне несотворён, и Клодекссарамас угасает над Бледным Пределом. Ты повёл Рассвет в самое сердце некрополя и вырвал его, {playerName}. Эта победа твоя, и орден будет петь о ней.",
        "objectives": {
          "0": {
            "label": "Архилич Воротне сражён"
          }
        }
      },
      "q_cx_legend_1": {
        "title": "Осколки Скорбного Света",
        "text": "Прежде чем у некрополя появился владыка, {playerName}, в нём хранился посох истинного света, Скорбный Свет, и когда он пал, посох разлетелся вдребезги. Пять осколков лежат у владык кварталов Клодекссарамаса. Они отдают их редко, так что ты пройдёшь некрополь множество раз. Принеси мне все пять.",
        "completion": "Пять осколков, каждый вырван у иного владыки мёртвых. Я чувствую, как Скорбный Свет пробуждается меж ними. Возьми эту незажжённую оправу; она удержит их, пока мы работаем.",
        "objectives": {
          "0": {
            "label": "Осколок Скорбного Света"
          }
        }
      },
      "q_cx_legend_2": {
        "title": "Незажжённый Посох",
        "text": "Оправа держит пять осколков, но она не пробудится, {playerName}. Скорбному Свету нужно сердце, вокруг которого он будет гореть, и лишь одно осталось достаточно холодным и достаточно ярким, чтобы послужить: Полая Звезда, вделанная в самую грудь Воротне. Принеси мне незажжённый посох и приготовься к тому, что грядёт дальше.",
        "completion": "Оправа связана и уравновешена, каждый осколок сидит как должно. Теперь ей недостаёт лишь Звезды. Ты знаешь, где она лежит.",
        "objectives": {
          "0": {
            "label": "Незажжённый Посох Скорбного Света"
          }
        }
      },
      "q_cx_legend_3": {
        "title": "Полая Звезда",
        "text": "Полая Звезда горит в груди Воротне, и он не отдаст её, пока стоит на ногах, {playerName}. Вернись к трону, покончи с Архиличем снова и вырви Звезду из останков его. Принеси её мне, и Скорбный Свет наконец загорится для Рассвета.",
        "completion": "Свершилось. Полая Звезда сидит на навершии посоха, и Скорбный Свет пылает белым впервые за целую эпоху. Возьми его, {playerName}: Скорбный Свет, Посох Полого Рассвета. Ни одна рука не заслужила его так, как твоя. Пусть его свет станет последним, что узрит тьма Клодекссарамаса.",
        "objectives": {
          "0": {
            "label": "Полая Звезда"
          }
    ...
    "zones": {
      ...
      "ashen_wastes": {
        ...
        "welcome": "Пепельные пустоши простираются, серые и безжизненные. Нечто огромное низко парит над мёртвой землёй.",
        "pois": {
          "0": {
            "label": "Могильная стража"
          },
          "1": {
            "label": "Пепельный перевал"
          },
          "2": {
            "label": "Стылое озеро"
          },
          ...
          "4": {
            "label": "Пустые курганы"
          },
          "5": {
            "label": "Бледный предел"
          }
        }
      },
      "alderfen_shallows": {
