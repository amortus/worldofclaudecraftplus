  ...
  "entities": {
    ...
    "npcs": {
      ...
      "dawn_commander_sera": {
        "name": "司令官セラ",
        "title": "クロードの夜明け",
        "greeting": "戦列を保て、{className}。あの宙に浮く墓所、Claudexxaramasが、この地のすべてを灰色に染め上げたのだ。クロードの夜明けは、魂の一つひとつまで、必ずや取り戻してみせる。"
      },
      "dawn_chaplain_orin": {
        "name": "従軍司祭オリン",
        "title": "クロードの夜明け",
        "greeting": "聖なる光は今なおここに届いている、{playerName}、たとえか細くともな。死にゆく者を看取り、あの船が我らに降らせる疫病を断つのを手伝ってくれ。"
      },
      "dawn_quartermaster_henning": {
        "name": "需品官ヘニング",
        "title": "クロードの夜明け",
        "greeting": "鋼と信仰、{playerName}、それが私に差し出せるすべてだ。夜明けの信頼を勝ち取れば、需品官の蔵が一つひとつ、お前に開かれていくだろう。"
      },
      "dawn_scout_irelle": {
        "name": "斥候イレル",
        "title": "クロードの夜明け",
        "greeting": "私は死者の道を、踏み込める限り北の彼方まで地図に記した、{className}。淡き辺境に近づくほど、船のささやきは大きくなる。足元に気をつけることだ。"
      },
      "dawn_archivist_vael": {
        "name": "記録官ヴェル",
        "title": "クロードの夜明け",
        "greeting": "あの死霊要塞の欠片を一つ調べるごとに、いつの日かこじ開けられるかもしれぬ亀裂が一つ見えてくるのだ、{playerName}。死者が携えしものを持ち帰ってくれ。そうすれば、突入の計を共に練ろう。"
      },
      "dawn_vanguard_kael": {
        "name": "先鋒隊長カエル",
        "title": "クロードの夜明け",
        "greeting": "クロードホルムはかつて生ける町だった、{playerName}よ。あの船の影が落ちる前はな。今やその死者たちが通りを支配している。我らは本日、ここを突破する。"
      },
      "dawn_reclaimer_sela": {
        "name": "奪還者セラ",
        "title": "クロードの夜明け",
        "greeting": "クロードホルムの死者は救えぬ、{playerName}よ。ただ解き放つことしかできぬ。町が失ったものを取り戻し、クロードサラマスそのものを開く鍵を私が鍛えるのを手伝っておくれ。"
      },
      "dawn_warbringer_torv": {
        "name": "戦の使者トルヴ",
        "title": "クロードの暁",
        "greeting": "ついに裂け目が開いた、{playerName}よ。死者の都が、その死者たちを淡き辺境へとあふれ出させている。クロードの暁を率いてクロードザクサラマスへ攻め入り、一区画ずつ攻略し、その主たちを討ち倒すのだ。"
      },
      "dawn_loreseeker_miren": {
        "name": "知識を求める者ミレン",
        "title": "クロードの暁",
        "greeting": "あの死者の都には、その主よりも古き遺物があるのです、{playerName}よ。砕けて破片となり、死者たちのあいだに散らばった杖です。それらを集めてください。そうすれば、共にモーンライトを再び灯すことができましょう。"
      },
      "dawn_huntsman_varik": {
        "name": "狩人ヴァリク",
        "title": "クロードの夜明け",
        "greeting": "穢れは獣にまで及んだ、{playerName}。南の荒野の牡鹿どもは、その目に緑の炎を灯して立ち上がり、狐どもは彼らの残した亡骸を貪っている。穢れがこれ以上広がらぬよう、わたしは奴らを狩っているのだ。お前の弓を、いや、その刃を貸してくれ。"
      },
      "weirwarden_ondrey": {
    ...
    "quests": {
      ...
      "q_nythraxis_bound_guardian": {
        "title": "縛られし守護者",
        "text": "ヴォスは、生存者たちが偶然や野心でニスラクシスの墓に辿り着く者を防ぐため、王の印章指輪を古代の守護者の奥に封じたと記しています。墓所の要石を、廃棄された墓所の北西、大祭司マルリックの墓の北東にある平地の儀式陣へ持っていってください。そこで使い、守護者を破り、指輪を持ち帰ってください。",
      ...
      "q_aw_arrival": {
        "title": "灰と凶兆",
        "text": "墓守の地へようこそ、{playerName}、もっとも、穢れが我らに残したわずかな土地だがな。夜ごと、斃れし者どもの抜け殻が我らの壁を引っ掻く。八体を打ち倒し、我が兵らが眠れるようにしてくれ。さすれば、クロードの夜明けはお前を友となるべき者と認めよう。",
        "completion": "門にたかる怪異が八体減ったか。お前は確かな腕を持っている、{playerName}。夜明けは、我らと共に立つ者を忘れはしない。",
        "objectives": {
          "0": {
            "label": "穢れの抜け殻を討伐"
          }
      ...
      "q_aw_husks": {
        "title": "歩む穢れ",
        "text": "抜け殻どもは無心ではない、{playerName}。奴らは群れ、我らの戦列を探っている。我らの弱点を見抜かれる前に、さらに十二体を間引いてくれ。この踏み靴を持っていけ。荒野は靴に厳しいからな。",
        "completion": "よし。お前が焼き払う抜け殻の一体ごとに、今宵もう二度と起き上がれぬ一体となるのだ。",
        "objectives": {
          "0": {
            "label": "穢れの抜け殻を討伐"
          }
      ...
      "q_aw_ghouls": {
        "title": "獣じみた飢え",
        "text": "灰燼のグールどもは骸野で群れをなして狩りをする、素早く、狂暴にな。奴らはすでに我が斥候を二人も引きずり去った。間引いてくれ、十体も斃せば群れは崩れるはずだ。門へ突入するほどに増長する前にな。",
        "completion": "群れは散り散りになった。お前のおかげで、我が斥候たちはふたたび骸野を見回れるようになった。",
        "objectives": {
          "0": {
            "label": "灰燼のグールを討伐"
          }
      ...
      "q_aw_crawlers": {
        "title": "広がりゆく病",
        "text": "疫病の這い虫は噛みつきによって穢れを運ぶのだ、{playerName}。そして奴らは静淵の泥の中で繁殖する。十体を斃してくれ。奴らが這う先には病がついて回る。すでに塞がれた寝台はあまりに多いのだ。",
        "completion": "寝台にかけた護りも、これでもう少し持ちこたえるだろう。聖なる光がお前に感謝している、私が忘れているときでさえな。",
        "objectives": {
          "0": {
            "label": "疫病の這い虫を討伐"
          }
      ...
      "q_aw_samples": {
        "title": "穢れた検体",
        "text": "穢れを癒すには、まずそれを理解せねばならぬ。抜け殻や這い虫どもはそれを骨の髄まで染み込ませている。奴らの腐った肉から穢れた検体を六つ持ち帰ってくれ、そして慎重に扱うのだ。穢れは、誰の血を腐らせようと頓着せぬのだから。",
        "completion": "六つの検体、どれもが前のものより悪い。この腐敗には……規則性がある。意図的だ。これは自然の疫病などではない、{playerName}。",
        "objectives": {
          "0": {
            "label": "穢れた検体"
          }
      ...
      "q_aw_acolytes": {
        "title": "船の声",
        "text": "生ける者どもが今やClaudexxaramasにひざまずいている、{playerName}。荒野じゅうにその意志を唱え歩く、堕ちた侍祭どもだ。もはや我らが救える者ではない。十人を黙らせよ。この手甲を持っていけ。これが終わるまでに、お前はもっと酷いものを稼ぐことになる。",
        "completion": "唱える声がほころび始めた。あの船が何を築いているにせよ、お前は十の進んで捧げられた喉を奪い取ったのだ。",
        "objectives": {
          "0": {
            "label": "堕ちた侍祭を討伐"
          }
      ...
      "q_aw_orders": {
        "title": "天よりの命令",
        "text": "侍祭どもは書かれた命令書を携えている、{playerName}。船が語り、奴らがそれを書き写すのだ。さらに八人を斬り伏せ、その命令書を四束持ち帰ってくれ。我らが命じられる前に、Claudexxaramasが何を命じているのかを知りたいのだ。",
        "completion": "この文字は、見つめると這うように動く。だが間違いなく命令だ。死者を集め、淡き辺境を整えよ、とな。奴らは何かに備えている。",
        "objectives": {
          "0": {
            "label": "堕ちた侍祭を討伐"
          },
      ...
      "q_aw_reavers": {
        "title": "骸野",
        "text": "骸の略奪者どもは歩く武器庫だ、{playerName}。船の刃へと鋳直された古き兵士たちよ。骸野で奴らを十二体打ち砕いてくれ。お前が散らす略奪者の一体ごとが、二度と夜明けに振り下ろされぬ鋼となるのだ。",
        "completion": "十二体の略奪者が砕け散ったか。あれだけの廃材があれば、我が炉の火を絶やさずに済む。よくやった。",
        "objectives": {
          "0": {
            "label": "骸の略奪者を討伐"
          }
      ...
      "q_aw_wraiths": {
        "title": "うつろなる墓所",
        "text": "ここより北の古き墓所が目覚めた、{playerName}。墓から小亡霊が漂い出てくる。生ける者から温もりを吸い取る、冷たき者どもだ。十体を安らがせてやれ。この荒野の死者は、あの船に仕えるよりは良き末路にふさわしいのだ。",
        "completion": "十の魂が、闇へと安らかに還っていった。お前が伝えてくれた通り、一つひとつに祈りを捧げた。ささやかな慈悲ではあるが、それは我らのものだ。",
        "objectives": {
          "0": {
            "label": "墓所の小亡霊を討伐"
          }
      ...
      "q_aw_relics": {
        "title": "聖別されし遺物",
        "text": "墓所には古き信仰の遺物が眠っている。かつては聖別されていたが、今や小亡霊どもの手によって冒涜されてしまった。墓から五つを取り戻してくれ、{playerName}。浄められ、ふたたび祝福されれば、それらは私の衰えゆく祈りよりはるかに良く寝台を護ってくれるだろう。",
        "completion": "五つの遺物、その一つひとつが、穢れが晴れるにつれて手の中で温かくなっていく。聖なる光はこの地から去ってはいなかったのだ。ただ、家へ持ち帰る者が必要だっただけだ。",
        "objectives": {
          "0": {
            "label": "冒涜された聖遺物"
          }
      ...
      "q_aw_hold": {
        "title": "墓守の地を守り抜け",
        "text": "ありていに言おう、{playerName}。我らは地歩を失いつつある。略奪者どもは夜ごと骸野へ強く押し寄せてくる。守備隊に一週間の息継ぎを稼ぐため、さらに十四体を打ち砕く必要がある。夜明けはお前を頼りにしてよいか。",
        "completion": "一週間。お前は我らに一週間を稼いでくれた。それを無駄にはせぬ、そして、それを稼いだ者を決して忘れぬ。",
        "objectives": {
          "0": {
            "label": "骸の略奪者を討伐"
          }
      ...
      "q_aw_behemoth": {
        "title": "腐れゆくベヒモス",
        "text": "静淵で何か巨大なものが動いている、{playerName}。継ぎ接ぎされ腐りゆく死者でできたベヒモスだ。我らの壁を垣根のように歩き抜けるほどの大きさよ。仲間を一人か二人連れていき、墓守の地に到達する前に倒してこい。この帯帷子が打撃に耐える助けとなろう。",
        "completion": "あの肉の山を斃したか。ここからでも、地の震えが止まるのを感じたぞ。夜明けは、あの一件でお前に借りができた。",
        "objectives": {
          "0": {
            "label": "腐れゆくベヒモスを討伐"
          }
      ...
      "q_aw_zealots": {
        "title": "疫病をもたらす者ども",
        "text": "疫病をもたらす狂信者どもは、淡き辺境への進入路に腐敗の爆発をまき散らしている、{playerName}。そして奴らは、一振りの刃が斃すよりも速く互いを癒し合う。八体を斃せ。激しく、そして揃って叩け。決して奴らを回り込ませて癒させるな。",
        "completion": "八体の狂信者、そして奴らがまいていた腐敗も奴らと共に死んだ。進入路はふたたび通れるようになった。かろうじてな。",
        "objectives": {
          "0": {
            "label": "疫病をもたらす狂信者を討伐"
          }
      ...
      "q_aw_deathguard": {
        "title": "船の番人ども",
        "text": "Naxxramasの死霊衛兵どもは、船そのものの番人だ、{playerName}。黒き重鎧をまとう精鋭の死者で、Claudexxaramasが最も低く垂れ込める場所に配されている。十体を打ち砕いてくれ。夜明けが、あの死霊要塞のまさに影の下で戦えるのかを知らねばならぬ。この兜はかつて死霊衛兵のものだった。奴らに立ち向かうため、これを身につけよ。",
        "completion": "船そのものの影の下で、十体の番人を斃したか。ならば、成し遂げられるということだ。ならば、いつの日か、我らは戦いを上へと持ち込める。お前はそれを示してくれたのだ、{playerName}。",
        "objectives": {
          "0": {
            "label": "Naxxramasの死霊衛兵を討伐"
          }
        }
      },
      "q_aw_morthax": {
        "title": "うつろなる主",
        "text": "前の季節、我らの一人がうつろなる墓所で斃れた。モルタックスという名の騎士だ。あの船が彼を起き上がらせた、{playerName}。そして今、うつろなるモルタックスは、かつて自らが率いた者たちを狩っている。彼を見つけ出せ。終わらせよ。そして、彼の顔を被るその物が真に滅したと確かめられるよう、その心臓を持ち帰ってくれ。",
        "completion": "冷たい。この心臓は石のように冷たく、彼に与えられた名の通りうつろだ。今は安らげ、モルタックス。お前は最後まで、いや、それを超えてなお、夜明けに仕えてくれた。",
        "objectives": {
          "0": {
            "label": "うつろなる心臓"
          }
      ...
      "q_aw_pale_reach": {
        "title": "淡き辺境へ",
        "text": "淡き辺境はこの地の最悪の場所だ、{playerName}。錨を下ろした船の真下に広がる剥き出しの地で、死霊衛兵がひしめいている。私一人では地図に記せぬ。私のために道を切り開いてくれ。Naxxramasの死霊衛兵を八体斃せ。その間に私はお前の背後の地を写し取る。",
        "completion": "手に入れたぞ。辺境のすべてを、ついに地図に記した。すべての巡回路と尖塔をな。記録官ヴェルがこれを欲しがるだろう。そして司令官も、船へ進軍する日が来たときにはな。",
        "objectives": {
          "0": {
            "label": "Naxxramasの死霊衛兵を討伐"
          }
      ...
      "q_aw_ritual": {
        "title": "儀式を打ち砕け",
        "text": "狂信者どもは淡き辺境で儀式を執り行い、Claudexxaramasをさらに低くへ引き寄せようとしている、{playerName}。奴らはそれぞれ、儀式を繋ぎ留める儀式の触媒を携えている。それを四つ奪い取り、その過程で狂信者を六体斃せ。錨を断ち切れば、儀式は止まる。",
        "completion": "触媒は辺境を離れた瞬間に光を失う。四つの錨を断ち切ったか。船は今日、これ以上低くは垂れ込めぬ。それは勝利だ、いかにささやかであろうとな。",
        "objectives": {
          "0": {
            "label": "儀式の触媒"
          },
      ...
      "q_aw_attune_1": {
        "title": "Claudexxaramasのこだま",
        "text": "死霊要塞を突破するには、まずそれを理解せねばならぬ、{playerName}。その番人どもは船体の断片を携えている。今なお船の鼓動を響かせる、死した金属だ。死霊衛兵から船の断片を三つ持ち帰ってくれ。そうすれば私は、Naxxramasの歌を学び始められる。",
        "completion": "共に響き合っている、聞いてくれ。同じ葬送歌の三つの音色だ。これを十分に集められれば、記録官よ、私は内部への道を地図に記せるだろう。これこそが、要塞を突破する手立てなのだ。",
        "objectives": {
          "0": {
            "label": "船の断片"
          }
      ...
      "q_aw_gravelord": {
        "title": "墓守公オス",
        "text": "墓守公オスは、地上における船の手だ、{playerName}。穢れのすべてを淡き辺境に繋ぎ留めている副官よ。最も強き仲間を集めよ。これは一人の、いや三人でも挑むべき戦いではない。墓守公を斬り伏せれば、荒野そのものが癒え始めるやもしれぬ。",
        "completion": "オスは死んだ。そして見よ、辺境の灰はすでに灰緑へと淡んでいきつつある。お前はただ副官を斃したのではない、{playerName}。お前は、Claudexxaramasが血を流しうると夜明けに示したのだ。",
        "objectives": {
          "0": {
            "label": "墓守公オスを討伐"
          }
      ...
      "q_aw_attunement": {
        "title": "Naxxramasへの突破口",
        "text": "オスが死に、墓守公の錨が断たれた今、船は無防備に垂れ込めている、{playerName}。今こそその時だ。船の断片をさらに五つ持ち帰ってくれ。私はそれを夜明けの紋章へと鍛え上げよう。Naxxramasそのものへのお前の心象適合だ。クロードの夜明けがついにあの死霊要塞へ攻め入るとき、紋章を帯びる者が突破口を率いる。さすれば、攻略に要する血と鋼は、本来の半分で済むだろう。",
        "completion": "成った。夜明けの紋章はお前のものだ、{playerName}。この一団のあらゆる魂への証であり、お前が死霊要塞に挑む覚悟ができたという証だ。我らがClaudexxaramasへ進軍するとき、お前は最前列を進む。我らの中で崇拝され、突破口に適合した者としてな。夜明けが、これ以上真なる勇者を求めることはできぬ。",
        "objectives": {
          "0": {
            "label": "船の断片"
          }
      ...
      "q_aw_rotting_herd": {
        "title": "腐りゆく群れ",
        "text": "南の荒野の牡鹿どもは、もはや牡鹿ではない、{playerName}。穢れが群れ全体を蝕み、今や息あるものすべてに突進してくる。その角からは緑の汁が滴っている。連中を間引いてくれ、八体も斃せば群れは崩れるだろう。奴らが北の墓守の砦へとさまよい出る前にな。",
        "completion": "腐れ獣が八体減った。今夜、群れは野営地に届くまい。見事な狩りだ、{playerName}。",
        "objectives": {
          "0": {
            "label": "穢れた牡鹿を討伐"
          }
      ...
      "q_aw_ash_scavengers": {
        "title": "灰の漁り屋",
        "text": "牡鹿が斃れる場所には、狐どもが寄ってくる、{playerName}。腐りゆく小さな漁り屋どもで、引きずっていく亡骸ひとつごとに穢れをより広く撒き散らすのだ。八体を始末し、穢れの這い寄りを食い止めてくれ。",
        "completion": "漁り屋どもは散り散りになった。よし。お前が一体倒すごとに、荒野の一里がもう少しだけ長く清いままでいられる。",
        "objectives": {
          "0": {
            "label": "腐りゆく狐を討伐"
          }
      ...
      "q_aw_corrupt_sample": {
        "title": "腐れの種子",
        "text": "この獣どもにどれほど深く穢れが及んでいるか知りたいのだ、{playerName}。牡鹿から穢れた角を六本持ってきてくれ。緑の腐れは骨にこそ最も激しく巣食う。それを読めば、どれほどの速さで広がっているか分かるだろう。もし群れがすでに失われているなら、夜明けはそれを知らねばならぬ。",
        "completion": "六本の角、どれも芯まで腐っている。穢れは今や奴らの骨髄にまで達しているのだ、{playerName}。群れを救う術はない、ただ終わらせるのみ。だが、夜明けは何と対峙しているかを知った。それは清き一撃よりも価値のあることだ。",
        "objectives": {
          "0": {
            "label": "穢れた角"
          }
      ...
      "q_ch_breach": {
        "title": "クロードホルムの突破",
        "text": "廃墟の中の門は、クロードホルムそのものへと通じている、{playerName}よ。あの船がひと晩で殺した町まるごとへとな。門番が第一の区画を守っている。それを打ち破れば、夜明けは内部に足場を得る。",
        "completion": "門は我らのものだ。進め、{playerName}よ。通りはここから悪化する一方だ。",
        "objectives": {
          "0": {
            "label": "門番を討伐"
          }
      ...
      "q_ch_vats": {
        "title": "疫病の醸造槽",
        "text": "疫病細工師セヴラは、クロードホルムを死せるままに保つ腐敗を醸している、{playerName}よ。第二区画の奥深くの槽でな。彼女を絶てば、その疫病の泉は涸れる。",
        "completion": "セヴラは倒れ、その槽は冷え果てた。第二区画の空気は今やほとんど呼吸に耐えるほどだ。",
        "objectives": {
          "0": {
            "label": "疫病細工師セヴラを討伐"
          }
      ...
      "q_ch_toll": {
        "title": "魂の通行料",
        "text": "通行料の徴収者は、第三区画で町の魂を溜め込んでいる、{playerName}よ。それを少しずつあの船に喰わせているのだ。打ち倒し、その魂たちを解き放て。",
        "completion": "通行料の徴収者は砕かれ、それが抱えていた魂は風に舞う灰のごとく散り散りになった。ついに、自由となったのだ。",
        "objectives": {
          "0": {
            "label": "通行料の徴収者を討伐"
          }
      ...
      "q_ch_pit": {
        "title": "腐肉の坑",
        "text": "第四区画は腐肉の坑だ、{playerName}よ。そして蛆の王ブルクは、その底で縫い合わされた死者の山と化している。仲間を総出で連れて行け。あの化け物を打ち倒すのだ。",
        "completion": "ついにブルクは弾け飛んだ。今や坑は渡れる、{playerName}よ。とはいえ、渡る間に深く息を吸うのは勧めぬがな。",
        "objectives": {
          "0": {
            "label": "蛆の王ブルクを討伐"
          }
      ...
      "q_ch_chapel": {
        "title": "冒涜の儀式",
        "text": "聖歌隊長マウルは、古い礼拝堂で死者を率いて冒涜の儀式を行っている、{playerName}よ。第五区画だ。彼はかつて光の司祭であった。その讃美歌を黙らせ、礼拝堂を安らがせよ。",
        "completion": "讃美歌は静まった。船に奪われる前のマウルが何者であったにせよ、今や彼はそれから解き放たれた。光が彼を守らんことを。",
        "objectives": {
          "0": {
            "label": "聖歌隊長マウルを討伐"
          }
      ...
      "q_ch_muster": {
        "title": "招集を打ち破れ",
        "text": "灰の元帥は、第六区画で町の死せる民兵を鍛え上げている、{playerName}よ。彼らを隊列へと招集しているのだ。死者の軍勢こそ、この荒野が最も必要としないものだ。その指揮官を打ち破れ。",
        "completion": "灰の元帥は倒れ、その隊列は彼なくして骨へと崩れ落ちる。本日、クロードホルムから軍勢が進軍することはない。",
        "objectives": {
          "0": {
            "label": "灰の元帥を討伐"
          }
      ...
      "q_ch_forge": {
        "title": "骨鍛冶師を黙らせよ",
        "text": "骨鍛冶師は、第七区画で死者を構造物へと鍛えている、{playerName}よ。船のための尽きせぬ骨兵の列をな。その鍛冶場を打ち砕き、その鎚を黙らせよ。",
        "completion": "鎚は静まり、鍛冶場は冷え果てた。骨兵の列はここで終わる、{playerName}よ。残るは死の王のみだ。",
        "objectives": {
          "0": {
            "label": "骨鍛冶師を討伐"
          }
      ...
      "q_ch_deathlord": {
        "title": "虚ろなる卿",
        "text": "虚ろなる卿ヴェホルトは、最奥の区画からクロードホルムを支配している、{playerName}よ。肉と化した船の死の王だ。この町が決して安らがぬのは彼のせいだ。集められるだけの最強の者を集め、彼を絶て。クロードホルムを永久に解き放つのだ。",
        "completion": "ヴェホルトは死に、船が来て以来この町が知らなかった静寂がクロードホルムを包む。お前は夜明けが見捨てた地を解き放った、{playerName}よ。我らはそれを忘れぬ。",
        "objectives": {
          "0": {
            "label": "虚ろなる卿ヴェホルトを討伐"
          }
      ...
      "q_ch_streets": {
        "title": "死者の通り",
        "text": "区画の主たちを狩る前に、{playerName}よ、クロードホルムの通りを塞ぐ抜け殻どもを間引け。十五体だ。お前の後ろに続く先鋒のための道を切り開くのだ。",
        "completion": "十五体の抜け殻を倒し、通りは通れるようになった。お前のおかげで、今や先鋒が動ける。",
        "objectives": {
          "0": {
            "label": "クロードホルムの抜け殻を討伐"
          }
        }
      },
      "q_ch_relics": {
        "title": "奪還された聖遺物",
        "text": "クロードホルムはかつて信仰篤き町だった、{playerName}よ。そしてその聖遺物は、今なおそれを守っていた死者たちの間に眠っている。六つ取り戻せ。再び祝福を受ければ、闇の中で朽ちるよりも夜明けの手にある方が、より大きな善をなすだろう。",
        "completion": "六つの聖遺物、その一つ一つが穢れの晴れるにつれ温もりを帯びる。町は少しずつその信仰を手放していく、{playerName}よ。そして我らはその分だけよく武装される。",
        "objectives": {
          "0": {
            "label": "奪還された聖遺物"
          }
      ...
      "q_ch_attune_1": {
        "title": "虚ろなる地のこだま",
        "text": "お前はナクスラマスに適合した、{playerName}よ。だがクロードサラマスそのものはより深き扉であり、その鍵はクロードホルムにある。それはヴェホルトから始まる。彼を打ち倒し、彼が携える虚ろの紋章を持ち帰れ。三つのうちの最初の一片だ。",
        "completion": "虚ろの紋章は、打たれた鐘のごとく私の手の中で鳴り響く。三つのうちの一片だ、{playerName}よ。突破鍵は実在し、我らはその作製に着手したのだ。",
        "objectives": {
          "0": {
            "label": "虚ろの紋章"
          }
      ...
      "q_ch_attune_2": {
        "title": "穢れし聖遺物",
        "text": "虚ろの紋章は疫病に穢れている、{playerName}よ。そして町自身の祝福された聖遺物のみがそれを浄化できる。クロードホルムの死者から奪還された聖遺物を五つ持ち帰れ。さすれば鍛造のために紋章を清めよう。",
        "completion": "五つの聖遺物を紋章の周りに並べると、穢れは古い皮のごとく剥がれ落ちる。今やそれは清められた、{playerName}よ。鍛冶の準備は整った。",
        "objectives": {
          "0": {
            "label": "奪還された聖遺物"
          }
      ...
      "q_ch_attune_3": {
        "title": "突破鍵を鍛えよ",
        "text": "紋章にはそれを固定する核が必要だ、{playerName}よ。そしてそれを携えるのは死の王のみだ。クロードホルムへ戻り、再びヴェホルトを打ち倒し、その骸から突破の核を持ち帰れ。二片目だ。",
        "completion": "突破の核は、いまだヴェホルトの胸より冷たいままだ。三つのうちの二片だ、{playerName}よ。突破鍵は私の手の中で形を成しつつある。",
        "objectives": {
          "0": {
            "label": "突破の核"
          }
      ...
      "q_ch_attune_4": {
        "title": "灰鉄と骨",
        "text": "突破鍵は灰鉄で覆われねばならぬ、{playerName}よ。骨鍛冶師が扱う呪われた金属だ。クロードホルムにある彼の鍛冶場から灰鉄の延べ棒を一つ持ち帰れ。さすれば外装は完成する。",
        "completion": "灰鉄、いまだ骨鍛冶師の炎より温かい。外装は鋳られた、{playerName}よ。残るは死の王の冠を鍵に戴かせることのみだ。",
        "objectives": {
          "0": {
            "label": "灰鉄の延べ棒"
          }
      ...
      "q_ch_attune_5": {
        "title": "クロードサラマスへの鍵",
        "text": "残るは一片だ、{playerName}よ。ヴェホルト自身の額にある虚ろの冠だ。最後にもう一度クロードホルムへ戻り、その冠を奪え。さすれば私がそれを突破鍵の頂に据えよう。それがあれば、クロードサラマスそのものが夜明けに向けて開かれ、お前が我らを率いて中へと進むのだ。",
        "completion": "成し遂げられた。夜明けの突破鍵はお前のものだ、{playerName}よ。紋章と核と冠、すべてが灰鉄に覆われている。クロードの夜明けがクロードサラマスを攻め落とすとき、それを開く鍵を携えるのはお前だ。この騎士団にこれ以上の英雄はおらぬ。備えておけ。突破の時は近い。",
        "objectives": {
          "0": {
            "label": "ヴェホルトの虚ろの冠"
          }
      ...
      "q_cx_breach": {
        "title": "裂け目が開く",
        "text": "破鍵が回り、クロードザクサラマスが我らの頭上に開け放たれた、{playerName}よ。その最初の区画、腐肉の広間は、縫い合わされた死者たちの屍の坑だ。造られざる者グロッシュまで斬り進み、その忌まわしきものを討ち倒せ。そうすれば暁は内部に足場を築ける。",
        "completion": "腐肉の広間は我らのものだ。一区画を制した、残りは四つ。死者の都は、そう易々と残りを明け渡しはすまい。",
        "objectives": {
          "0": {
            "label": "造られざる者グロッシュを討伐"
          }
        }
      },
      "q_cx_plague": {
        "title": "疫病工房",
        "text": "第二の区画、疫病工房では、クロードザクサラマスが我らの地に降らせる腐敗を醸造している。疫病王マガスがその大釜を司っている。彼を葬れ、{playerName}よ。そして疫病をその源で断つのだ。",
        "completion": "大釜は涸れ果てた。疫病工房がこれ以上、我らの畑を毒すことはない。おかげで暁はひと息つける。",
        "objectives": {
          "0": {
            "label": "疫病王マガスを討伐"
          }
      ...
      "q_cx_barracks": {
        "title": "死番兵営",
        "text": "死者の都は守備隊を抱えている、{playerName}よ。死番兵営、そこでは斃れた兵士たちが、終わることなき戦のために訓練を続けている。死護の三体一組が彼らを率いている。三体一組を打ち砕けば、守備隊もろともに崩れ去るだろう。",
        "completion": "三体一組は斃れ、その隊列は散り散りになった。兵営はもはや反撃を整えられまい。前進せよ、闇の中へと。",
        "objectives": {
          "0": {
            "label": "死護の三体一組を討伐"
          }
      ...
      "q_cx_spinning": {
        "title": "紡がれし闇",
        "text": "第四の区画は壁から壁まで蜘蛛の巣に覆われている、{playerName}よ。紡がれし闇、そこでは女主人セセルが、這い回るおのが子らを抱えて待ち構えている。蜘蛛の巣を焼き払い、その仔らが裂け目を呑み込む前に女主人を葬れ。",
        "completion": "セセルの仔らは灰となり、紡がれし闇は静まり返った。今やあなたの上にそびえるのは玉座のみ。",
        "objectives": {
          "0": {
            "label": "女主人セセルを討伐"
          }
      ...
      "q_cx_throne": {
        "title": "空虚なる玉座",
        "text": "これで終わりだ、{playerName}よ。空虚なる玉座は死者の都の心臓に据えられ、その上には大リッチ ヴォロスネ、すなわちクロードザクサラマスを突き動かす意志が座している。レイドの総力を結集せよ。彼を打ち倒せば、死者の都はその主と共に滅びる。",
        "completion": "ヴォロスネは消し去られ、クロードザクサラマスは淡き辺境の上空で暗く崩れ落ちた。あなたは暁を率いて死者の都の心臓まで攻め入り、それを抉り取った、{playerName}よ。この勝利はあなたのもの、騎士団はこれを歌い継ぐだろう。",
        "objectives": {
          "0": {
            "label": "大リッチ ヴォロスネを討伐"
          }
      ...
      "q_cx_legend_1": {
        "title": "モーンライトの破片",
        "text": "死者の都にまだ主がいなかった頃、{playerName}よ、そこには真なる光の杖、モーンライトがあった。そして都が陥ちたとき、その杖は砕け散った。五つの破片が、クロードザクサラマスの各区画の主たちのもとに眠っている。彼らはめったにそれを手放さぬゆえ、あなたは死者の都を幾度となく踏破することになろう。五つすべてを私のもとへ持ち帰ってください。",
        "completion": "五つの破片、それぞれが異なる死者の主から奪い取られたもの。その間でモーンライトが息づくのを感じます。この灯らぬ枠組みをお受け取りください。私たちが作業するあいだ、これが破片を留めておきましょう。",
        "objectives": {
          "0": {
            "label": "モーンライトの破片"
          }
      ...
      "q_cx_legend_2": {
        "title": "灯らぬ杖",
        "text": "枠組みは五つの破片を留めていますが、目覚めようとはしません、{playerName}よ。モーンライトには、その周りで燃える核が必要なのです。そして役目を果たせるほど冷たく、かつ輝かしいものは、ただ一つしか残っていません。ヴォロスネ自身の胸に据えられた空虚なる星です。灯らぬ杖を私のもとへ持ち帰り、次に来るものに備えて心を引き締めてください。",
        "completion": "枠組みは結び合わされ、釣り合いが取れました。どの破片も正しく収まっています。あとはただ星を欠くのみ。それがどこにあるかは、あなたもご存じでしょう。",
        "objectives": {
          "0": {
            "label": "灯らぬモーンライトの杖"
          }
      ...
      "q_cx_legend_3": {
        "title": "空虚なる星",
        "text": "空虚なる星はヴォロスネの胸で燃えており、彼は立っているかぎりそれを手放しません、{playerName}よ。玉座へ戻り、再び大リッチを葬り、その亡骸からその星を引き剥がしてください。それを私のもとへ持ち帰れば、モーンライトはついに暁のために燃えるでしょう。",
        "completion": "成し遂げられました。空虚なる星は杖の頂に据えられ、モーンライトは幾代ぶりに白く燃え上がっています。お受け取りください、{playerName}よ。モーンライト、空虚なる暁の杖です。あなたほどこれを勝ち得るにふさわしい者はいません。その光こそが、クロードザクサラマスの闇が最後に目にするものとなりますように。",
        "objectives": {
          "0": {
            "label": "空虚なる星"
          }
    ...
    "zones": {
      ...
      "ashen_wastes": {
        "name": "灰燼の荒野",
        "welcome": "灰燼の荒野が広がる、灰色で命のない大地。何か巨大なものが死んだ地表の低くを漂っている。",
        "pois": {
          "0": {
            "label": "墓守の砦"
          },
    ...
    "dungeons": {
      ...
      "claudeholme": {
        "name": "クロードホルム",
        "enterText": "亀裂を抜けてクロードホルムへ踏み込むと、死んだ町が蠢く。",
        "leaveText": "クロードホルムから這い上がり、灰色の光の中へ戻る。"
      },
      "claudexxaramas": {
        "name": "クロードザクサラマス",
        "enterText": "あなたはクロードザクサラマスの死者の都に踏み込んだ。死者たちが待ち構えている。",
        "leaveText": "あなたはクロードザクサラマスから退き、灰の風の中へと去っていく。"
      },
      "cinderforge": {
