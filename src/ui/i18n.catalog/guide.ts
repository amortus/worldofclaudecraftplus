...
export const guideStrings = {
  ...
  worldPage: {
    ...
    blightBlurb:
      'The grey, blasted country beyond the Ashen Pass, where nothing grows and the dead do not rest. The Dawn of Claude holds the bastion of Gravewatch against it.',
    ...
    blightGreeting:
      'Hold the line. That shadow overhead has bled this whole land grey, and we will take it back, soul by soul.',
    ...
    blightPlaceNotes:
      "Gravewatch is the Dawn of Claude's bastion and your home base in the Wastes. The Ashen Pass is the only road in from the peaks; the Stillmere lies grey and glass-still where nothing drinks; the Bonefields and the Hollow Barrows crawl with what the blight raises; and the Pale Reach runs out to the far, dead north.",
