...
export class MobileControls {
  ...
  start(): void {
    ...
    // `lostpointercapture` is the one event guaranteed to fire when capture is
    // lost, so treat it exactly like pointercancel here, mirroring the
    // moveSurface/cameraJoystick handlers above.
