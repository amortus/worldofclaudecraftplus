...
[Play now](https://worldofclaudecraft.com/) · [Host your own world](#host-your-own-world-one-command) · [Train an agent](#train-an-agent-headless-rl) · [Contributing](CONTRIBUTING.md) · [Discord](https://discord.gg/RMa4rgyhZ)
