...
The Service links to and relies on third-party services, including GitHub, Discord, and any advertising or analytics providers we use. We do not control these services and are not responsible for them. Your use of them is governed by their terms.
...
If you believe content on the Service infringes your intellectual property, contact us using Section 21 with enough detail to identify the work and the allegedly infringing material, and we will respond appropriately.
...
8. **Developer name and contact.** Questions, complaints, or claims regarding the App should be directed to us using the contact details in Section 21.
