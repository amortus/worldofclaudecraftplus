...
3. MEMORY SCAN. Read project MEMORY.md (path redacted)
   ...
   or emojis anywhere; live site worldofclaudecraft.com.br with test creds fernando/turbo564
...
Drive worldofclaudecraft.com.br (or local `npm run dev` + `npm run server`) via Playwright
