...
function relayItem(accountId: number): QueuedRelay {
  return {
    ...
    profileUrl: `https://worldofclaudecraft.com.br/c/claudemoon/adventurer${accountId}`,
  };
}
...
function activityItem(index: number, accountIds: number[]): QueuedActivity {
  return {
    ...
    realm: 'Claudemoon',
    profileUrl: `https://worldofclaudecraft.com.br/c/claudemoon/adventurer${accountIds[0]}`,
