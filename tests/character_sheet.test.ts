...
describe('characterSheet: shared fields', () => {
  it('derives classLabel, zone, virtualLevel, prestige, spec, avatar + profile urls', () => {
    ...
    expect(sheet.avatarUrl).toBe('https://worldofclaudecraft.com.br/avatar/shaman/0.png');
    expect(sheet.profileUrl).toBe('https://worldofclaudecraft.com.br/c/Thrallish');
