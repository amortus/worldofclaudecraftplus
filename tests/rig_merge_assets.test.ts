...
const RIGS = [
  ...
  // The cosmetic mech body is lazyPreload'd rather than loaded at boot, but it
  // still goes through optimizedScene when a player wears it, so it merges too.
  'players/Mech/characters/CombatMech',
  'enemies/necromancer',
