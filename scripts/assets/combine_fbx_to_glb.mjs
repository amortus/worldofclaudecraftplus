...
// USAGE
//   Folder mode (easiest):
//     node scripts/assets/combine_fbx_to_glb.mjs <inputDir> <out.glb> [options]
...
//   Explicit mode:
//     node scripts/assets/combine_fbx_to_glb.mjs --base mesh.fbx --anim walk.fbx \
...
const ENTRY = 'scripts/assets/combine_fbx_to_glb_entry.js';
